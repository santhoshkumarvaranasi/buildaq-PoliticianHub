...
export class MockDataService {
  ...
  classes = [
    ...
    // Mock data for Public Grievance Management
    grievances = [
      { id: 1, category: 'Roads', status: 'Open', date: '2025-12-01', priority: 'High', location: 'Ward 5', ticket: 'GRV-001', evidence: [], assignedTo: 'Volunteer A' },
      { id: 2, category: 'Water', status: 'In Progress', date: '2025-11-28', priority: 'Medium', location: 'Ward 2', ticket: 'GRV-002', evidence: [], assignedTo: 'Volunteer B' },
      { id: 3, category: 'Electricity', status: 'Resolved', date: '2025-11-25', priority: 'Low', location: 'Ward 7', ticket: 'GRV-003', evidence: [], assignedTo: 'Volunteer C' }
    ];
    getGrievances() {
      return this.grievances;
    }

    // Mock data for Constituency Database & Voter Segmentation
    voters = [
      { id: 1, name: 'Ravi Kumar', booth: '12', ward: '5', caste: 'OBC', gender: 'M', tags: ['senior citizen'], family: 'Kumar Family' },
      { id: 2, name: 'Sita Devi', booth: '14', ward: '2', caste: 'SC', gender: 'F', tags: ['government staff'], family: 'Devi Family' },
      { id: 3, name: 'Amit Singh', booth: '15', ward: '7', caste: 'General', gender: 'M', tags: ['influencer'], family: 'Singh Family' }
    ];
    getVoters() {
      return this.voters;
    }

    // Mock data for Development Works & Projects Dashboard
    works = [
      { id: 1, title: 'Road Repair - Main St', status: 'In Progress', startDate: '2025-11-20', endDate: '', contractor: 'ABC Infra', budget: 500000, progress: 60 },
      { id: 2, title: 'Drainage Upgrade - Ward 2', status: 'Sanctioned', startDate: '', endDate: '', contractor: '', budget: 200000, progress: 0 },
      { id: 3, title: 'School Renovation - Ward 7', status: 'Completed', startDate: '2025-10-01', endDate: '2025-11-15', contractor: 'XYZ Builders', budget: 300000, progress: 100 }
    ];
    getWorks() {
      return this.works;
    }

    // Politician mock data
    politicians = [
      { id: 1, name: 'Jane Smith', party: 'Progressive', state: 'California', termStart: '2022-01-01', termEnd: '2026-01-01' },
      { id: 2, name: 'John Doe', party: 'Conservative', state: 'Texas', termStart: '2020-01-01', termEnd: '2024-01-01' },
      { id: 3, name: 'Priya Kumar', party: 'Independent', state: 'New York', termStart: '2023-06-01', termEnd: '2027-06-01' }
    ];
