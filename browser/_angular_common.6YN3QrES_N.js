import { a as Lt, b as Mt, c as Tt, d as U, e as Rt, f as Ot, g as Bt, h as Pt } from "@nf-internal/chunk-BDBESTHV";
import { a as Y, b as K } from "@nf-internal/chunk-4CLCTAJ7";
import * as a from "@angular/core";
import { \u0275findLocaleData as y, \u0275LocaleDataIndex as f, \u0275getLocaleCurrencyCode as Vt, \u0275getLocalePluralCase as Gt, \u0275RuntimeError as b, \u0275formatRuntimeError as Zi, inject as We, LOCALE_ID as x, createNgModule as Ht, NgModuleRef as Wt, RendererStyleFlags2 as Zt, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as Yt, \u0275isPromise as Kt, \u0275isSubscribable as Xt, untracked as xe, InjectionToken as Ze, DEFAULT_CURRENCY_CODE as qt } from "@angular/core";
import * as O from "@angular/core";
import { inject as Ne, InjectionToken as Nt, DOCUMENT as kt, \u0275\u0275inject as xt } from "@angular/core";
...
var P = (() => { class e {
    ...
    static \u0275prov = O.\u0275\u0275defineInjectable({ token: e, factory: () => Ne(ke), providedIn: "root" });
} return e; })(), q = new Nt(""), ke = (() => { class e extends P {
    _platformLocation;
    _baseHref;
    _removeListenerFns = [];
    constructor(t, n) { super(), this._platformLocation = t, this._baseHref = n ?? this._platformLocation.getBaseHrefFromDOM() ?? Ne(kt).location?.origin ?? ""; }
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = jt(Be(Pe(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    normalize(t) { return e.stripTrailingSlash(zt(this._basePath, Pe(t))); }
    ...
    static \u0275fac = function (n) { return new (n || e)(O.\u0275\u0275inject(P)); };
    static \u0275prov = O.\u0275\u0275defineInjectable({ token: e, factory: () => Ut(), providedIn: "root" });
} return e; })();
function Ut() { return new he(xt(P)); }
function zt(e, i) { if (!e || !i.startsWith(e))
    return i; let t = i.substring(e.length); return t === "" || ["/", ";", "?", "#"].includes(t[0]) ? t : i; }
function Pe(e) { return e.replace(/\/index.html$/, ""); }
function jt(e) { if (new RegExp("^(https?:)?//").test(e)) {
    let [, t] = e.split(/\/\/[^\/]+/);
    return t;
} return e; }
...
function rn(e) { return Vt(e); }
function sn(e) { return y(e)[f.Currencies]; }
var tt = Gt;
function nt(e) { if (!e[f.ExtraData])
    throw new b(2303, !1); }
function it(e) { let i = y(e); return nt(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? ge(n) : [ge(n[0]), ge(n[1])]); }
function rt(e, i, t) { let n = y(e); nt(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], s = v(r, i) || []; return v(s, t) || []; }
function on(e) { return y(e)[f.Directionality]; }
function v(e, i) { for (let t = i; t > -1; t--)
    if (typeof e[t] < "u")
        return e[t]; throw new b(2304, !1); }
function ge(e) { let [i, t] = e.split(":"); return { hours: +i, minutes: +t }; }
function st(e, i, t = "en") { let n = sn(t)[e] || Ye[e] || [], r = n[1]; return i === "narrow" && typeof r == "string" ? r : n[0] || e; }
var an = 2;
function ot(e) { let i, t = Ye[e]; return t && (i = t[2]), typeof i == "number" ? i : an; }
var un = /^(\d{4,})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/, J = {}, cn = /((?:[^BEGHLMOSWYZabcdhmswyz']+)|(?:'(?:[^']|'')*')|(?:G{1,5}|y{1,4}|Y{1,4}|M{1,5}|L{1,5}|w{1,2}|W{1}|d{1,2}|E{1,6}|c{1,6}|a{1,5}|b{1,5}|B{1,5}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|S{1,3}|z{1,4}|Z{1,5}|O{1,4}))([\s\S]*)/;
function at(e, i, t, n) { let r = Cn(e); i = T(t, i) || i; let o = [], u; for (; i;)
    if (u = cn.exec(i), u) {
        ...
        o.push(i);
        break;
    } let D = r.getTimezoneOffset(); n && (D = ct(n, D), r = mn(r, n)); let h = ""; return o.forEach(g => { let c = Dn(g); h += c ? c(r, t, D) : g === "''" ? "'" : g.replace(/(^'|'$)/g, "").replace(/''/g, "'"); }), h; }
function ie(e, i, t) { let n = new Date(0); return n.setFullYear(e, i, t), n.setHours(0, 0, 0), n; }
function T(e, i) { let t = Xe(e); if (J[t] ??= {}, J[t][i])
...
function dn(e, i) { return L(e, 3).substring(0, i); }
function C(e, i, t = 0, n = !1, r = !1) { return function (s, o) { let u = ln(e, s); if ((t > 0 || u > -t) && (u += t), e === 3)
    u === 0 && t === -12 && (u = 12);
else if (e === 6)
    return dn(u, i); let D = _(o, m.MinusSign); return L(u, i, D, n, r); }; }
...
function l(e, i, t = E.Format, n = !1) { return function (r, s) { return fn(r, s, e, i, t, n); }; }
function fn(e, i, t, n, r, s) { switch (t) {
    case 2: return Qe(i, r, n)[e.getMonth()];
    case 1: return Je(i, r, n)[e.getDay()];
    case 0:
        let o = e.getHours(), u = e.getMinutes();
        if (s) {
            let h = it(i), g = rt(i, r, n), c = h.findIndex(F => { if (Array.isArray(F)) {
                let [p, w] = F, $ = o >= p.hours && u >= p.minutes, B = o < w.hours || o === w.hours && u < w.minutes;
                if (p.hours < w.hours) {
                    if ($ && B)
                        return !0;
                }
        ...
        return qe(i, r, n)[o < 12 ? 0 : 1];
    case 3: return et(i, n)[e.getFullYear() <= 0 ? 0 : 1];
    default:
        let D = t;
        throw new b(2302, !1);
} }
...
var hn = 0, ne = 4;
function gn(e) { let i = ie(e, hn, 1).getDay(); return ie(e, 0, 1 + (i <= ne ? ne : ne + 7) - i); }
function ut(e) { let i = e.getDay(), t = i === 0 ? -3 : ne - i; return ie(e.getFullYear(), e.getMonth(), e.getDate() + t); }
function De(e, i = !1) { return function (t, n) { let r; if (i) {
    ...
    let s = ut(t), o = gn(s.getFullYear()), u = s.getTime() - o.getTime();
    r = 1 + Math.round(u / 6048e5);
} return L(r, e, _(n, m.MinusSign)); }; }
function te(e, i = !1) { return function (t, n) { let s = ut(t).getFullYear(); return L(s, e, _(n, m.MinusSign), i); }; }
var pe = {};
function Dn(e) { if (pe[e])
...
function ct(e, i) { e = e.replace(/:/g, ""); let t = Date.parse("Jan 01, 1970 00:00:00 " + e) / 6e4; return isNaN(t) ? i : t; }
function pn(e, i) { return e = new Date(e.getTime()), e.setMinutes(e.getMinutes() + i), e; }
function mn(e, i, t) { let r = e.getTimezoneOffset(), s = ct(i, r); return pn(e, -1 * (s - r)); }
function Cn(e) { if ($e(e))
...
function $e(e) { return e instanceof Date && !isNaN(e.valueOf()); }
var Fn = /^(\d+)?\.((\d+)(-(\d+))?)?$/, Ue = 22, re = ".", G = "0", En = ";", wn = ",", me = "#", ze = "\xA4", An = "%";
function we(e, i, t, n, r, s, o = !1) { let u = "", D = !1; if (!isFinite(e))
    u = _(t, m.Infinity);
else {
    let h = _n(e);
    o && (h = Sn(h));
    ...
    if (s) {
        ...
        if (k === null)
            throw new b(2306, !1);
        let Re = k[1], fe = k[3], Oe = k[5];
        Re != null && (g = Ce(Re)), fe != null && (c = Ce(fe)), Oe != null ? F = Ce(Oe) : fe != null && c > F && (F = c);
    }
    bn(h, c, F);
    let p = h.digits, w = h.integerLen, $ = h.exponent, B = [];
    ...
    p.length && Z.unshift(p.join("")), u = Z.join(_(t, n)), B.length && (u += _(t, r) + B.join("")), $ && (u += _(t, m.Exponential) + "+" + $);
} return e < 0 && !D ? u = i.negPre + u + i.negSuf : u = i.posPre + u + i.posSuf, u; }
function dt(e, i, t, n, r) { let s = ae(i, W.Currency), o = Ae(s, _(i, m.MinusSign)); return o.minFrac = ot(n), o.maxFrac = o.minFrac, we(e, o, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(ze, t).replace(ze, "").trim(); }
function lt(e, i, t) { let n = ae(i, W.Percent), r = Ae(n, _(i, m.MinusSign)); return we(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(An, "g"), _(i, m.PercentSign)); }
function ft(e, i, t) { let n = ae(i, W.Decimal), r = Ae(n, _(i, m.MinusSign)); return we(e, r, i, m.Group, m.Decimal, t); }
function Ae(e, i = "-") { let t = { minInt: 1, minFrac: 0, maxFrac: 0, posPre: "", posSuf: "", negPre: "", negSuf: "", gSize: 0, lgSize: 0 }, n = e.split(En), r = n[0], s = n[1], o = r.indexOf(re) !== -1 ? r.split(re) : [r.substring(0, r.lastIndexOf(G) + 1), r.substring(r.lastIndexOf(G) + 1)], u = o[0], D = o[1] || ""; t.posPre = u.substring(0, u.indexOf(me)); for (let g = 0; g < D.length; g++) {
    let c = D.charAt(g);
    c === G ? t.minFrac = t.maxFrac = g + 1 : c === me ? t.maxFrac = g + 1 : t.posSuf += c;
} let h = u.split(wn); if (t.gSize = h[1] ? h[1].length : 0, t.lgSize = h[2] || h[1] ? (h[2] || h[1]).length : 0, s) {
    let g = r.length - t.posPre.length - t.posSuf.length, c = s.indexOf(me);
...
function _n(e) { let i = Math.abs(e) + "", t = 0, n, r, s, o, u; for ((r = i.indexOf(re)) > -1 && (i = i.replace(re, "")), (s = i.search(/e/i)) > 0 ? (r < 0 && (r = s), r += +i.slice(s + 1), i = i.substring(0, s)) : r < 0 && (r = i.length), s = 0; i.charAt(s) === G; s++)
    ; if (s === (u = i.length))
    n = [0], r = 1;
else {
    for (u--; i.charAt(u) === G;)
...
} return r > Ue && (n = n.splice(0, Ue - 1), t = r - 1, r = 1), { digits: n, exponent: t, integerLen: r }; }
...
var ue = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: () => new gt(We(x)), providedIn: "root" });
} return e; })();
function ht(e, i, t, n) { let r = `=${e}`; if (i.indexOf(r) > -1 || (r = t.getPluralCategory(e, n), i.indexOf(r) > -1))
    return r; if (i.indexOf("other") > -1)
    return "other"; throw new b(2308, !1); }
var gt = (() => { class e extends ue {
    locale;
    constructor(t) { super(), this.locale = t; }
    getPluralCategory(t, n) { switch (tt(n || this.locale)(t)) {
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(ye) : je; }
    set ngClass(t) { this.rawClass = typeof t == "string" ? t.trim().split(ye) : t; }
    ...
    _toggleClass(t, n) { t = t.trim(), t.length > 0 && t.split(ye).forEach(r => { n ? this._renderer.addClass(this._ngEl.nativeElement, r) : this._renderer.removeClass(this._ngEl.nativeElement, r); }); }
    ...
    ngOnChanges(t) { if (this._needToReCreateComponentInstance(t) && (this._viewContainerRef.clear(), this._inputsUsed.clear(), this._componentRef = void 0, this.ngComponentOutlet)) {
        ...
        this._needToReCreateNgModuleInstance(t) && (this._moduleRef?.destroy(), this.ngComponentOutletNgModule ? this._moduleRef = Ht(this.ngComponentOutletNgModule, Ln(n)) : this._moduleRef = void 0), this._componentRef = this._viewContainerRef.createComponent(this.ngComponentOutlet, { injector: n, ngModuleRef: this._moduleRef, projectableNodes: this.ngComponentOutletContent, environmentInjector: this.ngComponentOutletEnvironmentInjector });
    } }
...
function Ln(e) { return e.get(Wt).injector; }
var se = class {
    $implicit;
    ngForOf;
    index;
    ...
    } t.forEachIdentityChange(r => { let s = n.get(r.currentIndex); Ve(s, r); }); }
...
function Ve(e, i) { e.context.$implicit = i.item; }
var Mn = (() => { class e {
    _viewContainer;
    _context = new oe;
    ...
    set ngIfThen(t) { Ge(t, !1), this._thenTemplateRef = t, this._thenViewRef = null, this._updateView(); }
    set ngIfElse(t) { Ge(t, !1), this._elseTemplateRef = t, this._elseViewRef = null, this._updateView(); }
...
function Ge(e, i) { if (e && !e.createEmbeddedView)
    throw new b(2020, !1); }
var H = class {
    _viewContainerRef;
    _templateRef;
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(Se, 9)); };
...
var pt = (() => { class e {
    ...
    _updateView(t) { this._clearViews(); let n = Object.keys(this._caseViews), r = ht(t, n, this._localization); this._activateView(this._caseViews[r]); }
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275injectAttribute("ngPluralCase"), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(pt, 1)); };
    ...
    _setStyle(t, n) { let [r, s] = t.split("."), o = r.indexOf("-") === -1 ? void 0 : Zt.DashCase; n != null ? this._renderer.setStyle(this._ngEl.nativeElement, r, s ? `${n}${s}` : n, o) : this._renderer.removeStyle(this._ngEl.nativeElement, r, o); }
...
var Fe = class {
...
}, Nn = new Ee, kn = new Fe, xn = (() => { class e {
    _ref;
    _latestValue = null;
    ...
    transform(t) { if (t == null)
        return null; if (typeof t != "string")
        throw M(e, t); return t.replace(Un, n => n[0].toUpperCase() + n.slice(1).toLowerCase()); }
    static \u0275fac = function (n) { return new (n || e); };
...
} return e; })(), Vn = "mediumDate", mt = new Ze(""), Ct = new Ze(""), Gn = (() => { class e {
    locale;
    defaultTimezone;
    defaultOptions;
    ...
    transform(t, n, r, s) { if (t == null || t === "" || t !== t)
        return null; try {
        let o = n ?? this.defaultOptions?.dateFormat ?? Vn, u = r ?? this.defaultOptions?.timezone ?? this.defaultTimezone ?? void 0;
        return at(t, o, s || this.locale, u);
    }
    catch (o) {
        throw M(e, o.message);
    } }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(mt, 24), a.\u0275\u0275directiveInject(Ct, 24)); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "date", type: e, pure: !0 });
} return e; })(), Hn = /#/g, Wn = (() => { class e {
    _localization;
    constructor(t) { this._localization = t; }
    transform(t, n, r) { if (t == null)
        return ""; if (typeof n != "object" || n === null)
        throw M(e, n); let s = ht(t, Object.keys(n), this._localization, r); return n[s].replace(Hn, t.toString()); }
...
var Xn = (() => { class e {
    ...
    keyValues = [];
    compareFn = He;
    transform(t, n = He) { if (!t || !(t instanceof Map) && typeof t != "object")
...
function He(e, i) { let t = e.key, n = i.key; if (t === n)
    return 0; if (t == null)
    return 1; if (n == null)
...
var qn = (() => { class e {
    ...
    transform(t, n = this._defaultCurrencyCode, r = "symbol", s, o) { if (!_e(t))
        return null; o ||= this._locale, typeof r == "boolean" && (r = r ? "symbol" : "code"); let u = n || this._defaultCurrencyCode; r !== "code" && (r === "symbol" || r === "symbol-narrow" ? u = st(u, r === "symbol" ? "wide" : "narrow", o) : u = r); try {
        let D = be(t);
        return dt(D, o, u, n, s);
    }
    catch (D) {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(qt, 16)); };
...
import { inject as I, DestroyRef as St, \u0275registerLocaleData as ni, Version as ii, \u0275\u0275defineInjectable as ri, DOCUMENT as _t, \u0275formatRuntimeError as si, InjectionToken as Le, \u0275RuntimeError as Me, \u0275IMAGE_CONFIG as oi, Renderer2 as ai, ElementRef as ui, Injector as ci, \u0275performanceMarkFeature as di, numberAttribute as Et, booleanAttribute as ce, \u0275IMAGE_CONFIG_DEFAULTS as li, \u0275unwrapSafeValue as fi, ChangeDetectorRef as hi } from "@angular/core";
import { DOCUMENT as Or, \u0275IMAGE_CONFIG as Br } from "@angular/core";
import * as yt from "@angular/core";
import "@angular/core";
var Ft = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = yt.\u0275\u0275defineInjectable({ token: e, factory: () => window.navigation, providedIn: "platform" });
} return e; })();
import "rxjs";
var mr = (() => { class e extends he {
    navigation = I(Ft);
    destroyRef = I(St);
    constructor() { super(I(P)), this.registerNavigationListeners(); }
...
function Cr(e, i, t) { return ni(e, i, t); }
var gi = "browser", Di = "server";
function yr(e) { return e === gi; }
function Fr(e) { return e === Di; }
var Er = new ii("21.0.3"), wr = (() => { class e {
    static \u0275prov = ri({ token: e, providedIn: "root", factory: () => typeof ngServerMode < "u" && ngServerMode ? new Ie : new ve(I(_t), window) });
} return e; })(), ve = class {
    document;
    window;
    offset = () => [0, 0];
...
function bt(e) { return /^https?:\/\//.test(e); }
function vt(e) { if (!(typeof e == "string") || e.trim() === "")
    return !1; try {
    let t = new URL(e);
    return !0;
}
...
var It = e => e.src, Te = new Le("", { factory: () => It });
function le(e, i) { return function (n) { return vt(n) || yi(n, i || []), n = mi(n), [{ provide: Te, useValue: o => (bt(o.src) && Fi(n, o.src), e(n, K(Y({}, o), { src: Ci(o.src) }))) }]; }; }
function yi(e, i) { throw new Me(2959, !1); }
function Fi(e, i) { throw new Me(2959, !1); }
var Ar = le(Ei, void 0);
function Ei(e, i) { let t = "format=auto"; return i.width && (t += `,width=${i.width}`), i.isPlaceholder && (t += `,quality=${de}`), `${e}/cdn-cgi/image/${t}/${i.src}`; }
var Sr = le(wi, void 0);
...
var _r = le(Ai, void 0);
function Ai(e, i) { let { src: t, width: n } = i, r = []; n && r.push(`w-${n}`), i.isPlaceholder && r.push(`q-${de}`); let s = r.length ? [e, `tr:${r.join(",")}`, t] : [e, t]; return new URL(s.join("/")).href; }
var br = le(Si, void 0);
function Si(e, i) { let t = new URL(`${e}/${i.src}`); return t.searchParams.set("auto", "format"), i.width && t.searchParams.set("w", i.width.toString()), i.isPlaceholder && t.searchParams.set("q", de), t.href; }
function vr(e) { if (e && !vt(e))
    throw new Me(2959, !1); return e && (e = new URL(e).origin), [{ provide: Te, useValue: n => _i(n, e) }]; }
var wt = new Map([["height", "h"], ["fit", "fit"], ["quality", "q"], ["q", "q"], ["position", "position"]]);
function _i(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !bt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", de); for (let [r, s] of Object.entries(e.loaderParams ?? {}))
    wt.has(r) && t.searchParams.set(wt.get(r), s.toString()); return t.hostname === "a" ? t.href.replace(t.origin, "") : t.href; }
var Ir = new Le("");
var bi = new Le("", { factory: () => new Set }), vi = (() => { class e {
    preloadedImages = I(bi);
    document = I(_t);
    errorShown = !1;
...
var Lr = (() => { class e {
    ...
    setHostAttributes() { this.fill ? this.sizes ||= "100vw" : (this.setHostAttribute("width", this.width.toString()), this.setHostAttribute("height", this.height.toString())), this.setHostAttribute("loading", this.getLoadingBehavior()), this.setHostAttribute("fetchpriority", this.getFetchPriority()), this.setHostAttribute("decoding", this.getDecoding()), this.setHostAttribute("ng-img", "true"); let t = this.updateSrcAndSrcset(); this.sizes ? this.getLoadingBehavior() === "lazy" ? this.setHostAttribute("sizes", "auto, " + this.sizes) : this.setHostAttribute("sizes", this.sizes) : this.ngSrcset && At.test(this.ngSrcset) && this.getLoadingBehavior() === "lazy" && this.setHostAttribute("sizes", "auto, 100vw"), typeof ngServerMode < "u" && ngServerMode && this.priority && this.injector.get(vi).createPreloadLinkTag(this.renderer, this.getRewrittenSrc(), t, this.sizes); }
    ...
    getRewrittenSrcset() { let t = At.test(this.ngSrcset); return this.ngSrcset.split(",").filter(r => r !== "").map(r => { r = r.trim(); let s = t ? parseFloat(r) : parseFloat(r) * this.width; return `${this.callImageLoader({ src: this.ngSrc, width: s })} ${r}`; }).join(", "); }
    getAutomaticSrcset() { return this.sizes ? this.getResponsiveSrcset() : this.getFixedSrcset(); }
    getResponsiveSrcset() { let { breakpoints: t } = this.config, n = t; return this.sizes?.trim() === "100vw" && (n = t.filter(s => s >= Li)), n.map(s => `${this.callImageLoader({ src: this.ngSrc, width: s })} ${s}w`).join(", "); }
    ...
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > Mi || this.height > Ti), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== It && !t; }
    ...
    removePlaceholderOnLoad(t) { let n = () => { let o = this.injector.get(hi); r(), s(), this.placeholder = !1, o.markForCheck(); }, r = this.renderer.listen(t, "load", n), s = this.renderer.listen(t, "error", n); this.destroyRef.onDestroy(() => { r(), s(); }), Oi(t, n); }
    setHostAttribute(t, n) { this.renderer.setAttribute(this.imgElement, t, n); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275dir = R.\u0275\u0275defineDirective({ type: e, selectors: [["img", "ngSrc", ""]], hostVars: 18, hostBindings: function (n, r) { n & 2 && R.\u0275\u0275styleProp("position", r.fill ? "absolute" : null)("width", r.fill ? "100%" : null)("height", r.fill ? "100%" : null)("inset", r.fill ? "0" : null)("background-size", r.placeholder ? "cover" : null)("background-position", r.placeholder ? "50% 50%" : null)("background-repeat", r.placeholder ? "no-repeat" : null)("background-image", r.placeholder ? r.generatePlaceholder(r.placeholder) : null)("filter", r.placeholder && r.shouldBlurPlaceholder(r.placeholderConfig) ? "blur(15px)" : null); }, inputs: { ngSrc: [2, "ngSrc", "ngSrc", Bi], ngSrcset: "ngSrcset", sizes: "sizes", width: [2, "width", "width", Et], height: [2, "height", "height", Et], decoding: "decoding", loading: "loading", priority: [2, "priority", "priority", ce], loaderParams: "loaderParams", disableOptimizedSrcset: [2, "disableOptimizedSrcset", "disableOptimizedSrcset", ce], fill: [2, "fill", "fill", ce], placeholder: [2, "placeholder", "placeholder", Pi], placeholderConfig: "placeholderConfig", src: "src", srcset: "srcset" }, features: [R.\u0275\u0275NgOnChangesFeature] });
} return e; })();
function Ri(e) { let i = {}; return e.breakpoints && (i.breakpoints = e.breakpoints.sort((t, n) => t - n)), Object.assign({}, li, e, i); }
function Oi(e, i) { e.complete && e.naturalWidth && i(); }
function Bi(e) { return typeof e == "string" ? e : fi(e); }
function Pi(e) { return typeof e == "string" && e !== "true" && e !== "false" && e !== "" ? e : ce(e); }
export { q as APP_BASE_HREF, xn as AsyncPipe, Ot as BrowserPlatformLocation, ti as CommonModule, Qn as CurrencyPipe, Ct as DATE_PIPE_DEFAULT_OPTIONS, mt as DATE_PIPE_DEFAULT_TIMEZONE, Or as DOCUMENT, Gn as DatePipe, qn as DecimalPipe, E as FormStyle, A as FormatWidth, Jt as HashLocationStrategy, Wn as I18nPluralPipe, Zn as I18nSelectPipe, Br as IMAGE_CONFIG, Te as IMAGE_LOADER, Yn as JsonPipe, Xn as KeyValuePipe, Rt as LOCATION_INITIALIZED, he as Location, P as LocationStrategy, $n as LowerCasePipe, vn as NgClass, In as NgComponentOutlet, Dt as NgFor, Dt as NgForOf, se as NgForOfContext, Mn as NgIf, oe as NgIfContext, gt as NgLocaleLocalization, ue as NgLocalization, Lr as NgOptimizedImage, pt as NgPlural, On as NgPluralCase, Bn as NgStyle, Se as NgSwitch, Tn as NgSwitchCase, Rn as NgSwitchDefault, Pn as NgTemplateOutlet, W as NumberFormatStyle, m as NumberSymbol, Ir as PRECONNECT_CHECK_BLOCKLIST, ke as PathLocationStrategy, Jn as PercentPipe, U as PlatformLocation, Ft as PlatformNavigation, N as Plural, ei as SlicePipe, zn as TitleCasePipe, d as TranslationWidth, jn as UpperCasePipe, Er as VERSION, wr as ViewportScroller, Ke as WeekDay, Pt as XhrFactory, dt as formatCurrency, at as formatDate, ft as formatNumber, lt as formatPercent, st as getCurrencySymbol, rn as getLocaleCurrencyCode, nn as getLocaleCurrencyName, tn as getLocaleCurrencySymbol, z as getLocaleDateFormat, V as getLocaleDateTimeFormat, Je as getLocaleDayNames, qe as getLocaleDayPeriods, on as getLocaleDirection, et as getLocaleEraNames, it as getLocaleExtraDayPeriodRules, rt as getLocaleExtraDayPeriods, Qt as getLocaleFirstDayOfWeek, Xe as getLocaleId, Qe as getLocaleMonthNames, ae as getLocaleNumberFormat, _ as getLocaleNumberSymbol, tt as getLocalePluralCase, j as getLocaleTimeFormat, en as getLocaleWeekEndRange, ot as getNumberOfCurrencyDigits, yr as isPlatformBrowser, Fr as isPlatformServer, Ar as provideCloudflareLoader, Sr as provideCloudinaryLoader, _r as provideImageKitLoader, br as provideImgixLoader, vr as provideNetlifyLoader, Cr as registerLocaleData, Tt as \u0275DomAdapter, mr as \u0275NavigationAdapterForLocation, Ie as \u0275NullViewportScroller, gi as \u0275PLATFORM_BROWSER_ID, Di as \u0275PLATFORM_SERVER_ID, Lt as \u0275getDOM, S as \u0275normalizeQueryParams, Bt as \u0275parseCookieValue, Mt as \u0275setRootDomAdapter };
