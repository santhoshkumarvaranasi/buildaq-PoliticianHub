...
import { InjectionToken as w, forwardRef as l, \u0275isPromise as dt, \u0275RuntimeError as ne, untracked as m, computed as O, signal as x, EventEmitter as _, booleanAttribute as re, ChangeDetectorRef as Fe, inject as P, ApplicationRef as ct, DestroyRef as ht, afterNextRender as ft, Version as gt } from "@angular/core";
...
var Tn = (() => { class t extends q {
    ...
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "formGroupName", ""], ["", "formArrayName", ""], ["", "ngModelGroup", ""], ["", "formGroup", ""], ["", "formArray", ""], ["form", 3, "ngNoForm", ""], ["", "ngForm", ""]], hostVars: 16, hostBindings: function (i, r) { i & 2 && s.\u0275\u0275classProp("ng-untouched", r.isUntouched)("ng-touched", r.isTouched)("ng-pristine", r.isPristine)("ng-dirty", r.isDirty)("ng-valid", r.isValid)("ng-invalid", r.isInvalid)("ng-pending", r.isPending)("ng-submitted", r.isSubmitted); }, standalone: !1, features: [s.\u0275\u0275InheritDefinitionFeature] });
} return t; })();
...
var Un = y, Hn = t => t instanceof y, X = class extends y {
}, Ln = t => t instanceof X, D = new w("", { factory: () => B }), B = "always";
...
function fe(t, n) { if (!n)
    return null; Array.isArray(n); let e, i, r; return n.forEach(o => { o.constructor === we ? e = o : xt(o) ? i = o : r = o; }), r || i || e || null; }
...
var Rt = { provide: u, useExisting: l(() => Ke) }, N = Promise.resolve(), Ke = (() => { class t extends u {
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10), s.\u0275\u0275directiveInject(D, 8)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["form", 3, "ngNoForm", "", 3, "formGroup", "", 3, "formArray", ""], ["ng-form"], ["", "ngForm", ""]], hostBindings: function (i, r) { i & 1 && s.\u0275\u0275listener("submit", function (a) { return r.onSubmit(a); })("reset", function () { return r.onReset(); }); }, inputs: { options: [0, "ngFormOptions", "options"] }, outputs: { ngSubmit: "ngSubmit" }, exportAs: ["ngForm"], standalone: !1, features: [s.\u0275\u0275ProvidersFeature([Rt]), s.\u0275\u0275InheritDefinitionFeature] });
} return t; })();
...
}, Wn = F, kt = t => t instanceof F, Je = (() => { class t extends u {
    _parent;
...
var jt = { provide: u, useExisting: l(() => Gt) }, Gt = (() => { class t extends Je {
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(u, 5), s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "ngModelGroup", ""]], inputs: { name: [0, "ngModelGroup", "name"] }, exportAs: ["ngModelGroup"], standalone: !1, features: [s.\u0275\u0275ProvidersFeature([jt]), s.\u0275\u0275InheritDefinitionFeature] });
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(u, 9), s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10), s.\u0275\u0275directiveInject(g, 10), s.\u0275\u0275directiveInject(Fe, 8), s.\u0275\u0275directiveInject(D, 8)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "ngModel", "", 3, "formControlName", "", 3, "formControl", ""]], inputs: { name: "name", isDisabled: [0, "disabled", "isDisabled"], model: [0, "ngModel", "model"], options: [0, "ngModelOptions", "options"] }, outputs: { update: "ngModelChange" }, exportAs: ["ngModel"], standalone: !1, features: [s.\u0275\u0275ProvidersFeature([Tt]), s.\u0275\u0275InheritDefinitionFeature, s.\u0275\u0275NgOnChangesFeature] });
} return t; })();
var qn = (() => { class t {
...
var $t = (() => { class t {
...
}, zn = T, Zn = t => t instanceof T, ge = (() => { class t extends u {
    callSetDisabledState;
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10), s.\u0275\u0275directiveInject(D, 8)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, features: [s.\u0275\u0275InheritDefinitionFeature, s.\u0275\u0275NgOnChangesFeature] });
} return t; })(), Zt = { provide: u, useExisting: l(() => Xt) }, Xt = (() => { class t extends ge {
    form = null;
    ngSubmit = new _;
    get control() { return this.form; }
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "formArray", ""]], hostBindings: function (i, r) { i & 1 && s.\u0275\u0275listener("submit", function (a) { return r.onSubmit(a); })("reset", function () { return r.onReset(); }); }, inputs: { form: [0, "formArray", "form"] }, outputs: { ngSubmit: "ngSubmit" }, exportAs: ["ngForm"], standalone: !1, features: [s.\u0275\u0275ProvidersFeature([Zt]), s.\u0275\u0275InheritDefinitionFeature] });
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10), s.\u0275\u0275directiveInject(g, 10), s.\u0275\u0275directiveInject(pe, 8), s.\u0275\u0275directiveInject(D, 8)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "formControl", ""]], inputs: { form: [0, "formControl", "form"], isDisabled: [0, "disabled", "isDisabled"], model: [0, "ngModel", "model"] }, outputs: { update: "ngModelChange" }, exportAs: ["ngForm"], standalone: !1, features: [s.\u0275\u0275ProvidersFeature([Yt]), s.\u0275\u0275InheritDefinitionFeature, s.\u0275\u0275NgOnChangesFeature] });
} return t; })(), Jt = { provide: u, useExisting: l(() => Qe) }, Qe = (() => { class t extends Je {
    name = null;
    constructor(e, i, r) { super(), this._parent = e, this._setValidators(i), this._setAsyncValidators(r); }
    _checkParentType() { tt(this._parent); }
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(u, 13), s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10)); };
...
var en = { provide: f, useExisting: l(() => tn) }, tn = (() => { class t extends f {
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(u, 13), s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(C, 10), s.\u0275\u0275directiveInject(g, 10), s.\u0275\u0275directiveInject(pe, 8)); };
...
var it = (() => { class t extends V {
    ...
    _getOptionValue(e) { let i = on(e); return this._optionMap.has(i) ? this._optionMap.get(i) : e; }
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
...
var b = (() => { class t {
    ...
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["input", "type", "number", "min", "", "formControlName", ""], ["input", "type", "number", "min", "", "formControl", ""], ["input", "type", "number", "min", "", "ngModel", ""]], hostVars: 1, hostBindings: function (i, r) { i & 2 && s.\u0275\u0275attribute("min", r._enabled ? r.min : null); }, inputs: { min: "min" }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([cn]), s.\u0275\u0275InheritDefinitionFeature] });
    ...
    enabled(e) { return e; }
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "required", "", "formControlName", "", 3, "type", "checkbox"], ["", "required", "", "formControl", "", 3, "type", "checkbox"], ["", "required", "", "ngModel", "", 3, "type", "checkbox"]], hostVars: 1, hostBindings: function (i, r) { i & 2 && s.\u0275\u0275attribute("required", r._enabled ? "" : null); }, inputs: { required: "required" }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([fn]), s.\u0275\u0275InheritDefinitionFeature] });
} return t; })(), pn = (() => { class t extends at {
    createValidator = e => Oe;
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["input", "type", "checkbox", "required", "", "formControlName", ""], ["input", "type", "checkbox", "required", "", "formControl", ""], ["input", "type", "checkbox", "required", "", "ngModel", ""]], hostVars: 1, hostBindings: function (i, r) { i & 2 && s.\u0275\u0275attribute("required", r._enabled ? "" : null); }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([gn]), s.\u0275\u0275InheritDefinitionFeature] });
    ...
    enabled(e) { return e; }
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "email", "", "formControlName", ""], ["", "email", "", "formControl", ""], ["", "email", "", "ngModel", ""]], inputs: { email: "email" }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([mn]), s.\u0275\u0275InheritDefinitionFeature] });
    ...
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["", "pattern", "", "formControlName", ""], ["", "pattern", "", "formControl", ""], ["", "pattern", "", "ngModel", ""]], hostVars: 1, hostBindings: function (i, r) { i & 2 && s.\u0275\u0275attribute("pattern", r._enabled ? r.pattern : null); }, inputs: { pattern: "pattern" }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([Dn]), s.\u0275\u0275InheritDefinitionFeature] });
} return t; })();
var lt = (() => { class t {
    static \u0275fac = function (i) { return new (i || t); };
...
var ut = (() => { class t {
    ...
    group(e, i = null) { let r = this._reduceControls(e), o = {}; return Me(i) ? o = i : i !== null && (o.validators = i.validator, o.asyncValidators = i.asyncValidator), new y(r, o); }
    record(e, i = null) { let r = this._reduceControls(e); return new X(r, i); }
    control(e, i, r) { let o = {}; return this.useNonNullable ? (Me(i) ? o = i : (o.validators = i, o.asyncValidators = r), new F(e, h(c({}, o), { nonNullable: !0 }))) : new F(e, i, r); }
...
} return t; })(), Jn = (() => { class t extends ut {
