...
import { \u0275global as w, ApplicationRef as V, InjectionToken as I, \u0275Console as ge, Optional as $, Injector as Y, \u0275RuntimeError as g, SecurityContext as l, \u0275allowSanitizationBypassAndThrow as p, \u0275unwrapSafeValue as f, \u0275_sanitizeUrl as F, \u0275_sanitizeHtml as q, \u0275bypassSanitizationTrustHtml as X, \u0275bypassSanitizationTrustStyle as J, \u0275bypassSanitizationTrustScript as K, \u0275bypassSanitizationTrustUrl as Z, \u0275bypassSanitizationTrustResourceUrl as Q, \u0275withI18nSupport as W, \u0275withEventReplay as ee, \u0275withIncrementalHydration as te, makeEnvironmentProviders as ne, \u0275withDomHydration as re, ENVIRONMENT_INITIALIZER as Ee, inject as Te, \u0275IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as we, \u0275formatRuntimeError as Se, Version as oe } from "@angular/core";
...
} return t; })(), ie = { httpEquiv: "http-equiv" }, De = (() => { class t {
    _doc;
...
function D(t, i) { if (typeof COMPILED > "u" || !COMPILED) {
    let e = w.ng = w.ng || {};
    e[t] = i;
} }
var _ = class {
...
function Ce(t) { return D(C, new v(t)), t; }
function Re() { D(C, null); }
var S = class {
    static all() { return () => !0; }
...
var ae = { pan: !0, panstart: !0, panmove: !0, panend: !0, pancancel: !0, panleft: !0, panright: !0, panup: !0, pandown: !0, pinch: !0, pinchstart: !0, pinchmove: !0, pinchend: !0, pinchcancel: !0, pinchin: !0, pinchout: !0, press: !0, pressup: !0, rotate: !0, rotatestart: !0, rotatemove: !0, rotateend: !0, rotatecancel: !0, swipe: !0, swipeleft: !0, swiperight: !0, swipeup: !0, swipedown: !0, tap: !0, doubletap: !0 }, y = new I(""), R = new I(""), ce = (() => { class t {
    ...
    sanitize(e, n) { if (n == null)
        ...
        case l.HTML: return p(n, "HTML") ? f(n) : q(this._doc, String(n)).toString();
        case l.STYLE: return p(n, "Style") ? f(n) : n;
        case l.SCRIPT:
            if (p(n, "Script"))
                return f(n);
            throw new g(5200, !1);
        case l.URL: return p(n, "URL") ? f(n) : F(String(n));
        case l.RESOURCE_URL:
            if (p(n, "ResourceURL"))
                return f(n);
            throw new g(5201, !1);
...
function Ne(t) { return m(u.HttpTransferCacheOptions, b(t)); }
function Ae() { return m(u.I18nSupport, W()); }
