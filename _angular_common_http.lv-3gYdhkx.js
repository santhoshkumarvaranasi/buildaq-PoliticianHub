import { d as Re, g as Pe, h as Me } from "@nf-internal/chunk-BDBESTHV";
...
var xr = (() => { class e {
    ...
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac });
} return e; })(), me = new k("", { factory: () => !0 }), Ve = "XSRF-TOKEN", $e = new k("", { providedIn: "root", factory: () => Ve }), Ge = "X-XSRF-TOKEN", We = new k("", { providedIn: "root", factory: () => Ge }), Ke = (() => { class e {
    cookieName = T($e);
    doc = T(Fe);
    lastCookieString = "";
    lastToken = null;
