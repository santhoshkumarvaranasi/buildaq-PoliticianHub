import { a as Re, b as Pe } from "@nf-internal/chunk-KW5C2IEB";
import { a as J, c as be, d as re } from "@nf-internal/chunk-4CLCTAJ7";
import * as d from "@angular/core";
import { \u0275RuntimeError as O, InjectionToken as k, inject as v, NgZone as cr, DestroyRef as dr, \u0275formatRuntimeError as dt, \u0275TracingService as lr, runInInjectionContext as ae, PendingTasks as _e, DOCUMENT as xe, EnvironmentInjector as ur, makeEnvironmentProviders as hr } from "@angular/core";
import { switchMap as fr, finalize as Fe, concatMap as pr, filter as yr, map as V } from "rxjs/operators";
import { Observable as ce, from as mr, of as je } from "rxjs";
var b = class e {
    headers;
...
var ne = class {
    ...
    encodeKey(t) { return Me(t); }
    encodeValue(t) { return Me(t); }
    decodeKey(t) { return decodeURIComponent(t); }
    decodeValue(t) { return decodeURIComponent(t); }
};
function gr(e, t) { let r = new Map; return e.length > 0 && e.replace(/^\?/, "").split("&").forEach(o => { let s = o.indexOf("="), [i, c] = s == -1 ? [t.decodeKey(o), ""] : [t.decodeKey(o.slice(0, s)), t.decodeValue(o.slice(s + 1))], a = r.get(i) || []; a.push(c), r.set(i, a); }), r; }
var Tr = /%(\d[a-f0-9])/gi, vr = { 40: "@", "3A": ":", 24: "$", "2C": ",", "3B": ";", "3D": "=", "3F": "?", "2F": "/" };
function Me(e) { return encodeURIComponent(e).replace(Tr, (t, r) => vr[r] ?? t); }
function $(e) { return `${e}`; }
var M = class e {
    map;
    encoder;
    ...
    constructor(t = {}) { if (this.encoder = t.encoder || new K, t.fromString) {
        if (t.fromObject)
            throw new O(2805, !1);
        this.map = gr(t.fromString, this.encoder);
    }
    else
...
function wr(e) { return typeof URLSearchParams < "u" && e instanceof URLSearchParams; }
var B = "Content-Type", Y = "Accept", Le = "text/plain", Ce = "application/json", Ue = `${Ce}, ${Le}, */*`, F = class e {
    url;
    body = null;
    headers;
    context;
    ...
    serializeBody() { return this.body === null ? null : typeof this.body == "string" || Ne(this.body) || De(this.body) || Oe(this.body) || wr(this.body) ? this.body : this.body instanceof M ? this.body.toString() : typeof this.body == "object" || typeof this.body == "boolean" || Array.isArray(this.body) ? JSON.stringify(this.body) : this.body.toString(); }
    detectContentTypeHeader() { return this.body === null || Oe(this.body) ? null : De(this.body) ? this.body.type || null : Ne(this.body) ? null : typeof this.body == "string" ? Le : this.body instanceof M ? "application/x-www-form-urlencoded;charset=UTF-8" : typeof this.body == "object" || typeof this.body == "number" || typeof this.body == "boolean" ? Ce : null; }
    clone(t = {}) { let r = t.method || this.method, n = t.url || this.url, o = t.responseType || this.responseType, s = t.keepalive ?? this.keepalive, i = t.priority || this.priority, c = t.cache || this.cache, a = t.mode || this.mode, p = t.redirect || this.redirect, y = t.credentials || this.credentials, g = t.referrer || this.referrer, T = t.integrity || this.integrity, R = t.referrerPolicy || this.referrerPolicy, m = t.transferCache ?? this.transferCache, l = t.timeout ?? this.timeout, u = t.body !== void 0 ? t.body : this.body, h = t.withCredentials ?? this.withCredentials, E = t.reportProgress ?? this.reportProgress, N = t.headers || this.headers, f = t.params || this.params, D = t.context ?? this.context; return t.setHeaders !== void 0 && (N = Object.keys(t.setHeaders).reduce((x, I) => x.set(I, t.setHeaders[I]), N)), t.setParams && (f = Object.keys(t.setParams).reduce((x, I) => x.set(I, t.setParams[I]), f)), new e(r, n, u, { params: f, headers: N, context: D, reportProgress: E, responseType: o, withCredentials: h, transferCache: m, keepalive: s, cache: c, priority: i, timeout: l, mode: a, redirect: p, credentials: y, referrer: g, integrity: T, referrerPolicy: R }); }
...
}, de = 200, br = 204, Be = (function (e) { return e[e.Continue = 100] = "Continue", e[e.SwitchingProtocols = 101] = "SwitchingProtocols", e[e.Processing = 102] = "Processing", e[e.EarlyHints = 103] = "EarlyHints", e[e.Ok = 200] = "Ok", e[e.Created = 201] = "Created", e[e.Accepted = 202] = "Accepted", e[e.NonAuthoritativeInformation = 203] = "NonAuthoritativeInformation", e[e.NoContent = 204] = "NoContent", e[e.ResetContent = 205] = "ResetContent", e[e.PartialContent = 206] = "PartialContent", e[e.MultiStatus = 207] = "MultiStatus", e[e.AlreadyReported = 208] = "AlreadyReported", e[e.ImUsed = 226] = "ImUsed", e[e.MultipleChoices = 300] = "MultipleChoices", e[e.MovedPermanently = 301] = "MovedPermanently", e[e.Found = 302] = "Found", e[e.SeeOther = 303] = "SeeOther", e[e.NotModified = 304] = "NotModified", e[e.UseProxy = 305] = "UseProxy", e[e.Unused = 306] = "Unused", e[e.TemporaryRedirect = 307] = "TemporaryRedirect", e[e.PermanentRedirect = 308] = "PermanentRedirect", e[e.BadRequest = 400] = "BadRequest", e[e.Unauthorized = 401] = "Unauthorized", e[e.PaymentRequired = 402] = "PaymentRequired", e[e.Forbidden = 403] = "Forbidden", e[e.NotFound = 404] = "NotFound", e[e.MethodNotAllowed = 405] = "MethodNotAllowed", e[e.NotAcceptable = 406] = "NotAcceptable", e[e.ProxyAuthenticationRequired = 407] = "ProxyAuthenticationRequired", e[e.RequestTimeout = 408] = "RequestTimeout", e[e.Conflict = 409] = "Conflict", e[e.Gone = 410] = "Gone", e[e.LengthRequired = 411] = "LengthRequired", e[e.PreconditionFailed = 412] = "PreconditionFailed", e[e.PayloadTooLarge = 413] = "PayloadTooLarge", e[e.UriTooLong = 414] = "UriTooLong", e[e.UnsupportedMediaType = 415] = "UnsupportedMediaType", e[e.RangeNotSatisfiable = 416] = "RangeNotSatisfiable", e[e.ExpectationFailed = 417] = "ExpectationFailed", e[e.ImATeapot = 418] = "ImATeapot", e[e.MisdirectedRequest = 421] = "MisdirectedRequest", e[e.UnprocessableEntity = 422] = "UnprocessableEntity", e[e.Locked = 423] = "Locked", e[e.FailedDependency = 424] = "FailedDependency", e[e.TooEarly = 425] = "TooEarly", e[e.UpgradeRequired = 426] = "UpgradeRequired", e[e.PreconditionRequired = 428] = "PreconditionRequired", e[e.TooManyRequests = 429] = "TooManyRequests", e[e.RequestHeaderFieldsTooLarge = 431] = "RequestHeaderFieldsTooLarge", e[e.UnavailableForLegalReasons = 451] = "UnavailableForLegalReasons", e[e.InternalServerError = 500] = "InternalServerError", e[e.NotImplemented = 501] = "NotImplemented", e[e.BadGateway = 502] = "BadGateway", e[e.ServiceUnavailable = 503] = "ServiceUnavailable", e[e.GatewayTimeout = 504] = "GatewayTimeout", e[e.HttpVersionNotSupported = 505] = "HttpVersionNotSupported", e[e.VariantAlsoNegotiates = 506] = "VariantAlsoNegotiates", e[e.InsufficientStorage = 507] = "InsufficientStorage", e[e.LoopDetected = 508] = "LoopDetected", e[e.NotExtended = 510] = "NotExtended", e[e.NetworkAuthenticationRequired = 511] = "NetworkAuthenticationRequired", e; })(Be || {}), Rr = /^\)\]\}',?\n/, Se = new k(""), G = (() => { class e {
    fetchImpl = v(oe, { optional: !0 })?.fetch ?? ((...r) => globalThis.fetch(...r));
    ngZone = v(cr);
    destroyRef = v(dr);
    handle(r) { return new ce(n => { let o = new AbortController; this.doRequest(r, o.signal, n).then(se, i => n.error(new w({ error: i }))); let s; return r.timeout && (s = this.ngZone.runOutsideAngular(() => setTimeout(() => { o.signal.aborted || o.abort(new DOMException("signal timed out", "TimeoutError")); }, r.timeout))), () => { s !== void 0 && clearTimeout(s), o.abort(); }; }); }
    doRequest(r, n, o) { return re(this, null, function* () { let s = this.createRequestInit(r), i; try {
        ...
        Pr(l), o.next({ type: P.Sent }), i = yield l;
    }
    catch (l) {
        o.error(new w({ error: l, status: l.status ?? 0, statusText: l.statusText, url: r.urlWithParams, headers: l.headers }));
        return;
        ...
        let l = i.headers.get("content-length"), u = [], h = i.body.getReader(), E = 0, N, f, D = typeof Zone < "u" && Zone.current, x = !1;
        if (yield this.ngZone.runOutsideAngular(() => re(this, null, function* () { for (;;) {
            ...
            if (U)
                break;
            if (u.push(ee), E += ee.length, r.reportProgress) {
                f = r.responseType === "text" ? (f ?? "") + (N ??= new TextDecoder).decode(ee, { stream: !0 }) : void 0;
                let we = () => o.next({ type: P.DownloadProgress, total: l ? +l : void 0, loaded: E, partialText: f });
                D ? D.run(we) : we();
            }
        } })), x) {
            o.complete();
        ...
        let I = this.concatChunks(u, E);
        try {
            let U = i.headers.get(B) ?? "";
            g = this.parseBody(r, I, U, y);
        }
        catch (U) {
            o.error(new w({ error: U, headers: new b(i.headers), status: i.status, statusText: i.statusText, url: i.url || r.urlWithParams }));
            return;
        }
    } y === 0 && (y = g ? de : 0); let T = y >= 200 && y < 300, R = i.redirected, m = i.type; T ? (o.next(new A({ body: g, headers: c, status: y, statusText: a, url: p, redirected: R, responseType: m })), o.complete()) : o.error(new w({ error: g, headers: c, status: y, statusText: a, url: p, redirected: R, responseType: m })); }); }
    parseBody(r, n, o, s) { switch (r.responseType) {
        case "json":
            let i = new TextDecoder().decode(n).replace(Rr, "");
            if (i === "")
                return null;
            try {
                return JSON.parse(i);
    ...
    createRequestInit(r) { let n = {}, o; if (o = r.credentials, r.withCredentials && (o = "include"), r.headers.forEach((s, i) => n[s] = i.join(",")), r.headers.has(Y) || (n[Y] = Ue), !r.headers.has(B)) {
...
function se() { }
function Pr(e) { e.then(se, se); }
var Mr = /^\)\]\}',?\n/;
var le = (() => { class e {
    xhrFactory;
    tracingService = v(lr, { optional: !0 });
    ...
    handle(r) { if (r.method === "JSONP")
        throw new O(-2800, !1); let n = this.xhrFactory; return (typeof ngServerMode < "u" && ngServerMode && n.\u0275loadImpl ? mr(n.\u0275loadImpl()) : je(null)).pipe(fr(() => new ce(s => { let i = n.build(); if (i.open(r.method, r.urlWithParams), r.withCredentials && (i.withCredentials = !0), r.headers.forEach((u, h) => i.setRequestHeader(u, h.join(","))), r.headers.has(Y) || i.setRequestHeader(Y, Ue), !r.headers.has(B)) {
        ...
        return a; let u = i.statusText || "OK", h = new b(i.getAllResponseHeaders()), E = i.responseURL || r.url; return a = new S({ headers: h, status: i.status, statusText: u, url: E }), a; }, y = this.maybePropagateTrace(() => { let { headers: u, status: h, statusText: E, url: N } = p(), f = null; h !== br && (f = typeof i.response > "u" ? i.responseText : i.response), h === 0 && (h = f ? de : 0); let D = h >= 200 && h < 300; if (r.responseType === "json" && typeof f == "string") {
        let x = f;
        f = f.replace(Mr, "");
        try {
            ...
            f = x, D && (D = !1, f = { error: I, text: f });
        }
    } D ? (s.next(new A({ body: f, headers: u, status: h, statusText: E, url: N || void 0 })), s.complete()) : s.error(new w({ error: f, headers: u, status: h, statusText: E, url: N || void 0 })); }), g = this.maybePropagateTrace(u => { let { url: h } = p(), E = new w({ error: u, status: i.status || 0, statusText: i.statusText || "Unknown Error", url: h || void 0 }); s.error(E); }), T = g; r.timeout && (T = this.maybePropagateTrace(u => { let { url: h } = p(), E = new w({ error: new DOMException("Request timed out", "TimeoutError"), status: i.status || 0, statusText: i.statusText || "Request timeout", url: h || void 0 }); s.error(E); })); let R = !1, m = this.maybePropagateTrace(u => { R || (s.next(p()), R = !0); let h = { type: P.DownloadProgress, loaded: u.loaded }; u.lengthComputable && (h.total = u.total), r.responseType === "text" && i.responseText && (h.partialText = i.responseText), s.next(h); }), l = this.maybePropagateTrace(u => { let h = { type: P.UploadProgress, loaded: u.loaded }; u.lengthComputable && (h.total = u.total), s.next(h); }); return i.addEventListener("load", y), i.addEventListener("error", g), i.addEventListener("timeout", T), i.addEventListener("abort", g), r.reportProgress && (i.addEventListener("progress", m), c !== null && i.upload && i.upload.addEventListener("progress", l)), i.send(c), s.next({ type: P.Sent }), () => { i.removeEventListener("error", g), i.removeEventListener("abort", g), i.removeEventListener("load", y), i.removeEventListener("timeout", T), r.reportProgress && (i.removeEventListener("progress", m), c !== null && i.upload && i.upload.removeEventListener("progress", l)), i.readyState !== i.DONE && i.abort(); }; }))); }
    static \u0275fac = function (n) { return new (n || e)(d.\u0275\u0275inject(Pe)); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })();
function ze(e, t) { return t(e); }
function Nr(e, t) { return (r, n) => t.intercept(r, { handle: o => e(o, n) }); }
function Dr(e, t, r) { return (n, o) => ae(r, () => t(n, s => e(s, o))); }
var ue = new k(""), z = new k("", { factory: () => [] }), he = new k(""), fe = new k("", { providedIn: "root", factory: () => !0 });
function Or() { let e = null; return (t, r) => { e === null && (e = (v(ue, { optional: !0 }) ?? []).reduceRight(Nr, ze)); let n = v(_e); if (v(fe)) {
    let s = n.add();
    return e(t, r).pipe(Fe(s));
}
else
    return e(t, r); }; }
var X = (() => { class e {
...
var Z = (() => { class e {
    ...
    handle(r) { if (this.chain === null) {
        ...
        this.chain = n.reduceRight((o, s) => Dr(o, s, this.injector), ze);
    } if (this.contributeToStability) {
        let n = this.pendingTasks.add();
        return this.chain(r, o => this.backend.handle(o)).pipe(Fe(n));
    }
    else
...
var pe = (() => { class e {
    ...
    } let i = je(s).pipe(pr(a => this.handler.handle(a))); if (r instanceof F || o.observe === "events")
        return i; let c = i.pipe(yr(a => a instanceof A)); switch (o.observe || "body") {
    ...
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })(), Ir = 0, Ie, Ar = "JSONP injected script did not invoke callback.";
var Q = class {
};
function kr() { return typeof window == "object" ? window : {}; }
var ye = (() => { class e {
    callbackMap;
    document;
    resolvedPromise = Promise.resolve();
    constructor(r, n) { this.callbackMap = r, this.document = n; }
    nextCallback() { return `ng_jsonp_callback_${Ir++}`; }
    handle(r) { if (r.method !== "JSONP")
        throw new O(2810, !1); if (r.responseType !== "json")
        throw new O(2811, !1); if (r.headers.keys().length > 0)
        throw new O(2812, !1); return new ce(n => { let o = this.nextCallback(), s = r.urlWithParams.replace(/=JSONP_CALLBACK(&|$)/, `=${o}$1`), i = this.document.createElement("script"); i.src = s; let c = null, a = !1; this.callbackMap[o] = T => { delete this.callbackMap[o], c = T, a = !0; }; let p = () => { i.removeEventListener("load", y), i.removeEventListener("error", g), i.remove(), delete this.callbackMap[o]; }, y = () => { this.resolvedPromise.then(() => { if (p(), !a) {
        n.error(new w({ url: s, status: 0, statusText: "JSONP Error", error: new Error(Ar) }));
        return;
    } n.next(new A({ body: c, status: de, statusText: "OK", url: s })), n.complete(); }); }, g = T => { p(), n.error(new w({ error: T, status: 0, statusText: "JSONP Error", url: s })); }; return i.addEventListener("load", y), i.addEventListener("error", g), this.document.body.appendChild(i), n.next({ type: P.Sent }), () => { a || this.removeListeners(i), p(); }; }); }
    removeListeners(r) { Ie ??= this.document.implementation.createHTMLDocument(), Ie.adoptNode(r); }
    static \u0275fac = function (n) { return new (n || e)(d.\u0275\u0275inject(Q), d.\u0275\u0275inject(xe)); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac });
} return e; })();
function Xe(e, t) { return e.method === "JSONP" ? v(ye).handle(e) : t(e); }
var _r = (() => { class e {
    injector;
    constructor(r) { this.injector = r; }
    intercept(r, n) { return ae(this.injector, () => Xe(r, o => n.handle(o))); }
    static \u0275fac = function (n) { return new (n || e)(d.\u0275\u0275inject(d.EnvironmentInjector)); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac });
} return e; })(), me = new k("", { factory: () => !0 }), Je = "XSRF-TOKEN", Ve = new k("", { providedIn: "root", factory: () => Je }), $e = "X-XSRF-TOKEN", Ge = new k("", { providedIn: "root", factory: () => $e }), We = (() => { class e {
    cookieName = v(Ve);
    doc = v(xe);
    lastCookieString = "";
    lastToken = null;
    ...
    getToken() { if (typeof ngServerMode < "u" && ngServerMode)
        return null; let r = this.doc.cookie || ""; return r !== this.lastCookieString && (this.parseCount++, this.lastToken = Re(r, this.cookieName), this.lastCookieString = r), this.lastToken; }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })(), ge = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: function (n) { let o = null; return n ? o = new (n || e) : o = d.\u0275\u0275inject(We), o; }, providedIn: "root" });
} return e; })(), xr = /^(?:https?:)?\/\//i;
function Ke(e, t) { if (!v(me) || e.method === "GET" || e.method === "HEAD" || xr.test(e.url))
    return t(e); let r = v(ge).getToken(), n = v(Ge); return r != null && !e.headers.has(n) && (e = e.clone({ headers: e.headers.set(n, r) })), t(e); }
var Ae = (() => { class e {
    injector = v(ur);
    intercept(r, n) { return ae(this.injector, () => Ke(r, o => n.handle(o))); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac });
...
function Ye(...e) { let t = [pe, Z, { provide: q, useExisting: Z }, { provide: X, useFactory: () => v(Se, { optional: !0 }) ?? v(le) }, { provide: z, useValue: Ke, multi: !0 }]; for (let r of e)
    t.push(...r.\u0275providers); return hr(t); }
function Fr(e) { return j(_.Interceptors, e.map(t => ({ provide: z, useValue: t, multi: !0 }))); }
var ke = new k("");
function Ze() { return j(_.LegacyInterceptors, [{ provide: ke, useFactory: Or }, { provide: z, useExisting: ke, multi: !0 }]); }
function ie({ cookieName: e, headerName: t }) { let r = []; return e !== void 0 && r.push({ provide: Ve, useValue: e }), t !== void 0 && r.push({ provide: Ge, useValue: t }), j(_.CustomXsrfConfiguration, r); }
function Qe() { return j(_.NoXsrfProtection, [{ provide: me, useValue: !1 }]); }
function qe() { return j(_.JsonpSupport, [ye, { provide: Q, useFactory: kr }, { provide: z, useValue: Xe, multi: !0 }]); }
function jr() { return j(_.RequestsMadeViaParent, [{ provide: X, useFactory: () => v(q, { skipSelf: !0, optional: !0 }) }]); }
function Lr() { return j(_.Fetch, [G, { provide: Se, useExisting: G }, { provide: X, useExisting: G }]); }
var Cr = (() => { class e {
    ...
    static \u0275inj = d.\u0275\u0275defineInjector({ providers: [Ae, { provide: ue, useExisting: Ae, multi: !0 }, { provide: ge, useClass: We }, ie({ cookieName: Je, headerName: $e }).\u0275providers, { provide: me, useValue: !0 }] });
} return e; })(), Ur = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275mod = d.\u0275\u0275defineNgModule({ type: e });
    static \u0275inj = d.\u0275\u0275defineInjector({ providers: [Ye(Ze())] });
} return e; })(), Br = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275mod = d.\u0275\u0275defineNgModule({ type: e });
    static \u0275inj = d.\u0275\u0275defineInjector({ providers: [qe().\u0275providers] });
} return e; })();
import { inject as C, Injector as Sr, \u0275ResourceImpl as zr, linkedSignal as Te, computed as Xr, signal as Jr, \u0275encapsulateResourceError as Vr, \u0275RuntimeError as ir, InjectionToken as ar, \u0275performanceMarkFeature as $r, APP_BOOTSTRAP_LISTENER as Gr, ApplicationRef as Wr, TransferState as Kr, makeStateKey as Yr, \u0275truncateMiddle as wt, \u0275formatRuntimeError as bt } from "@angular/core";
import { of as Zr } from "rxjs";
import { tap as Qr } from "rxjs/operators";
var Mt = (() => { let e = H("json"); return e.arrayBuffer = H("arraybuffer"), e.blob = H("blob"), e.text = H("text"), e; })();
...
var ve = class extends zr {
    ...
    constructor(t, r, n, o, s, i) { super(r, ({ params: c, abortSignal: a }) => { let p, y = () => p.unsubscribe(); a.addEventListener("abort", y); let g = Jr({ value: void 0 }, {}), T, R = new Promise(l => T = l), m = l => { g.set(l), T?.(g), T = void 0; }; return p = this.client.request(c).subscribe({ next: l => { switch (l.type) {
            case P.Response:
            ...
            case P.DownloadProgress:
                ...
                break;
        } }, error: l => { l instanceof w && (this._headers.set(l.headers), this._statusCode.set(l.status)), m({ error: l }), a.removeEventListener("abort", y); }, complete: () => { T && m({ error: new ir(991, !1) }), a.removeEventListener("abort", y); } }), R; }, n, i, o, t), this.client = t.get(pe); }
    set(t) { super.set(t), this._headers.set(void 0), this._progress.set(void 0), this._statusCode.set(void 0); }
}, Hr = new ar(""), He = "b", er = "h", rr = "s", tr = "st", nr = "u", or = "rt", Ee = new ar(""), et = ["GET", "HEAD"];
function rt(e, t) { let R = C(Ee), { isCacheActive: r } = R, n = be(R, ["isCacheActive"]), { transferCache: o, method: s } = e; if (!r || o === !1 || s === "POST" && !n.includePostRequests && !o || s !== "POST" && !et.includes(s) || !n.includeRequestsWithAuthHeaders && tt(e) || n.filter?.(e) === !1)
    return t(e); let i = C(Kr), c = C(Hr, { optional: !0 }); if (typeof ngServerMode < "u" && !ngServerMode && c)
    throw new ir(2803, !1); let a = typeof ngServerMode < "u" && ngServerMode && c ? it(e.url, c) : e.url, p = ot(e, a), y = i.get(p, null), g = n.includeHeaders; if (typeof o == "object" && o.includeHeaders && (g = o.includeHeaders), y) {
    let { [He]: m, [or]: l, [er]: u, [rr]: h, [tr]: E, [nr]: N } = y, f = m;
    switch (l) {
        case "arraybuffer":
    ...
    let D = new b(u);
    return Zr(new A({ body: f, headers: D, status: h, statusText: E, url: N }));
} let T = t(e); return typeof ngServerMode < "u" && ngServerMode ? T.pipe(Qr(m => { m instanceof A && i.set(p, { [He]: m.body, [er]: nt(m.headers, g), [rr]: m.status, [tr]: m.statusText, [nr]: a, [or]: e.responseType }); })) : T; }
...
function ot(e, t) { let { params: r, method: n, responseType: o } = e, s = sr(r), i = e.serializeBody(); i instanceof URLSearchParams ? i = sr(i) : typeof i != "string" && (i = ""); let c = [n, o, t, i, s].join("|"), a = st(c); return Yr(a); }
function st(e) { let t = 0; for (let r of e)
    t = Math.imul(31, t) + r.charCodeAt(0) << 0; return t += 2147483648, t.toString(); }
function Nt(e) { return [{ provide: Ee, useFactory: () => ($r("NgHttpTransferCache"), J({ isCacheActive: !0 }, e)) }, { provide: he, useValue: rt, multi: !0 }, { provide: Gr, multi: !0, useFactory: () => { let t = C(Wr), r = C(Ee); return () => { t.whenStable().then(() => { r.isCacheActive = !1; }); }; } }]; }
function it(e, t) { let r = new URL(e, "resolve://").origin, n = t[r]; return n ? e.replace(r, n) : e; }
export { G as FetchBackend, ue as HTTP_INTERCEPTORS, Hr as HTTP_TRANSFER_CACHE_ORIGIN_MAP, X as HttpBackend, pe as HttpClient, Br as HttpClientJsonpModule, Ur as HttpClientModule, Cr as HttpClientXsrfModule, W as HttpContext, ne as HttpContextToken, w as HttpErrorResponse, P as HttpEventType, _ as HttpFeatureKind, q as HttpHandler, S as HttpHeaderResponse, b as HttpHeaders, M as HttpParams, F as HttpRequest, A as HttpResponse, L as HttpResponseBase, Be as HttpStatusCode, K as HttpUrlEncodingCodec, le as HttpXhrBackend, ge as HttpXsrfTokenExtractor, ye as JsonpClientBackend, _r as JsonpInterceptor, Mt as httpResource, Ye as provideHttpClient, Lr as withFetch, Fr as withInterceptors, Ze as withInterceptorsFromDi, qe as withJsonpSupport, Qe as withNoXsrfProtection, jr as withRequestsMadeViaParent, ie as withXsrfConfiguration, he as \u0275HTTP_ROOT_INTERCEPTOR_FNS, Z as \u0275HttpInterceptingHandler, fe as \u0275REQUESTS_CONTRIBUTE_TO_STABILITY, Nt as \u0275withHttpTransferCache };
