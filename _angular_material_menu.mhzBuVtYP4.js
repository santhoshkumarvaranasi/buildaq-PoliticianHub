import { a as N } from "@nf-internal/chunk-TBOQSXHX";
import { d as F } from "@nf-internal/chunk-AHQ2JYHE";
import { a as B } from "@nf-internal/chunk-WLM6SLJD";
import { b as w } from "@nf-internal/chunk-U6VGVGKT";
import { a as x, b as A } from "@nf-internal/chunk-4CLCTAJ7";
import * as n from "@angular/core";
import { InjectionToken as g, inject as s, ElementRef as T, DOCUMENT as S, ChangeDetectorRef as f, booleanAttribute as c, TemplateRef as Y, ApplicationRef as G, Injector as b, ViewContainerRef as V, QueryList as q, signal as Z, EventEmitter as d, afterNextRender as J, NgZone as $, Renderer2 as ee } from "@angular/core";
import { FocusMonitor as X, _IdGenerator as te, FocusKeyManager as ie, isFakeTouchstartFromScreenReader as ne, isFakeMousedownFromScreenReader as oe } from "@angular/cdk/a11y";
import { UP_ARROW as ae, DOWN_ARROW as se, RIGHT_ARROW as j, LEFT_ARROW as z, ESCAPE as re, hasModifierKey as le, ENTER as me, SPACE as ue } from "@angular/cdk/keycodes";
import { Subject as _, merge as P, Subscription as I, of as L } from "rxjs";
import { startWith as k, switchMap as H, takeUntil as ce, take as de, filter as he, skipWhile as pe } from "rxjs/operators";
import { _CdkPrivateStyleLoader as _e } from "@angular/cdk/private";
import { TemplatePortal as Q, DomPortalOutlet as ge } from "@angular/cdk/portal";
import { Directionality as fe, BidiModule as be } from "@angular/cdk/bidi";
import { createRepositionScrollStrategy as Me, createOverlayRef as ye, OverlayConfig as ve, createFlexibleConnectedPositionStrategy as Ce, ViewportRuler as xe, ScrollDispatcher as we, OverlayModule as ke } from "@angular/cdk/overlay";
import { _getEventTarget as De, _getShadowRoot as Pe } from "@angular/cdk/platform";
import { CdkScrollableModule as Ie } from "@angular/cdk/scrolling";
import "@angular/cdk/coercion";
import "@angular/cdk/layout";
var Re = ["mat-menu-item", ""], Te = [[["mat-icon"], ["", "matMenuItemIcon", ""]], "*"], Se = ["mat-icon, [matMenuItemIcon]", "*"];
function Oe(a, K) { a & 1 && (n.\u0275\u0275namespaceSVG(), n.\u0275\u0275elementStart(0, "svg", 2), n.\u0275\u0275element(1, "polygon", 3), n.\u0275\u0275elementEnd()); }
var Ee = ["*"];
function Ae(a, K) { if (a & 1) {
...
var O = new g("MAT_MENU_PANEL"), R = (() => { class a {
    _elementRef = s(T);
    _document = s(S);
    _focusMonitor = s(X);
    _parentMenu = s(O, { optional: !0 });
    ...
    _highlighted = !1;
    _triggersSubmenu = !1;
    constructor() { s(_e).load(B), this._parentMenu?.addItem?.(this); }
    ...
    static \u0275cmp = n.\u0275\u0275defineComponent({ type: a, selectors: [["", "mat-menu-item", ""]], hostAttrs: [1, "mat-mdc-menu-item", "mat-focus-indicator"], hostVars: 8, hostBindings: function (t, i) { t & 1 && n.\u0275\u0275listener("click", function (r) { return i._checkDisabled(r); })("mouseenter", function () { return i._handleMouseEnter(); }), t & 2 && (n.\u0275\u0275attribute("role", i.role)("tabindex", i._getTabIndex())("aria-disabled", i.disabled)("disabled", i.disabled || null), n.\u0275\u0275classProp("mat-mdc-menu-item-highlighted", i._highlighted)("mat-mdc-menu-item-submenu-trigger", i._triggersSubmenu)); }, inputs: { role: "role", disabled: [2, "disabled", "disabled", c], disableRipple: [2, "disableRipple", "disableRipple", c] }, exportAs: ["matMenuItem"], attrs: Re, ngContentSelectors: Se, decls: 5, vars: 3, consts: [[1, "mat-mdc-menu-item-text"], ["matRipple", "", 1, "mat-mdc-menu-ripple", 3, "matRippleDisabled", "matRippleTrigger"], ["viewBox", "0 0 5 10", "focusable", "false", "aria-hidden", "true", 1, "mat-mdc-menu-submenu-icon"], ["points", "0,0 5,5 0,10"]], template: function (t, i) { t & 1 && (n.\u0275\u0275projectionDef(Te), n.\u0275\u0275projection(0), n.\u0275\u0275elementStart(1, "span", 0), n.\u0275\u0275projection(2, 1), n.\u0275\u0275elementEnd(), n.\u0275\u0275element(3, "div", 1), n.\u0275\u0275conditionalCreate(4, Oe, 2, 0, ":svg:svg", 2)), t & 2 && (n.\u0275\u0275advance(3), n.\u0275\u0275property("matRippleDisabled", i.disableRipple || i.disabled)("matRippleTrigger", i._getHostElement()), n.\u0275\u0275advance(), n.\u0275\u0275conditional(i._triggersSubmenu ? 4 : -1)); }, dependencies: [F], encapsulation: 2, changeDetection: 0 });
} return a; })();
var W = new g("MatMenuContent"), ut = (() => { class a {
    _template = s(Y);
    _appRef = s(G);
    _injector = s(b);
    _viewContainerRef = s(V);
    _document = s(S);
    _changeDetectorRef = s(f);
    _portal;
    _outlet;
    _attached = new _;
    constructor() { }
    attach(e = {}) { this._portal || (this._portal = new Q(this._template, this._viewContainerRef)), this.detach(), this._outlet || (this._outlet = new ge(this._document.createElement("div"), this._appRef, this._injector)); let t = this._template.elementRef.nativeElement; t.parentNode.insertBefore(this._outlet.outletElement, t), this._changeDetectorRef.markForCheck(), this._portal.attach(this._outlet, e), this._attached.next(); }
    detach() { this._portal?.isAttached && this._portal.detach(); }
    ngOnDestroy() { this.detach(), this._outlet?.dispose(); }
    static \u0275fac = function (t) { return new (t || a); };
    static \u0275dir = n.\u0275\u0275defineDirective({ type: a, selectors: [["ng-template", "matMenuContent", ""]], features: [n.\u0275\u0275ProvidersFeature([{ provide: W, useExisting: a }])] });
} return a; })(), Fe = new g("mat-menu-default-options", { providedIn: "root", factory: () => ({ overlapTrigger: !1, xPosition: "after", yPosition: "below", backdropClass: "cdk-overlay-transparent-backdrop" }) }), D = "_mat-menu-enter", h = "_mat-menu-exit", p = (() => {
    class a {
        _elementRef = s(T);
        _changeDetectorRef = s(f);
        _injector = s(b);
        ...
        _animationsDisabled = w();
        _allItems;
        _directDescendantItems = new q;
        _classList = {};
        _panelAnimationState = "void";
        _animationDone = new _;
        _isAnimating = Z(!1);
        parentMenu;
        direction;
        overlayPanelClass;
        ...
        overlapTrigger;
        hasBackdrop;
        set panelClass(e) { let t = this._previousPanelClass, i = x({}, this._classList); t && t.length && t.split(" ").forEach(o => { i[o] = !1; }), this._previousPanelClass = e, e && e.length && (e.split(" ").forEach(o => { i[o] = !0; }), this._elementRef.nativeElement.className = ""), this._classList = i; }
        _previousPanelClass;
        get classList() { return this.panelClass; }
        set classList(e) { this.panelClass = e; }
        closed = new d;
        close = this.closed;
        panelId = s(te).getId("mat-menu-panel-");
        constructor() { let e = s(Fe); this.overlayPanelClass = e.overlayPanelClass || "", this._xPosition = e.xPosition, this._yPosition = e.yPosition, this.backdropClass = e.backdropClass, this.overlapTrigger = e.overlapTrigger, this.hasBackdrop = e.hasBackdrop; }
        ...
        _hovered() { return this._directDescendantItems.changes.pipe(k(this._directDescendantItems), H(t => P(...t.map(i => i._hovered)))); }
        addItem(e) { }
        removeItem(e) { }
        _handleKeydown(e) { let t = e.keyCode, i = this._keyManager; switch (t) {
            case re:
                le(e) || (e.preventDefault(), this.closed.emit("keydown"));
                break;
            case z:
            ...
            case j:
                ...
                break;
            default:
                (t === ae || t === se) && i.setFocusOrigin("keyboard"), i.onKeydown(e);
                return;
        } }
        focusFirstItem(e = "program") { this._firstItemFocusRef?.destroy(), this._firstItemFocusRef = J(() => { let t = this._resolvePanel(); if (!t || !t.contains(document.activeElement)) {
        ...
        setElevation(e) { }
        setPositionClasses(e = this.xPosition, t = this.yPosition) { this._classList = A(x({}, this._classList), { "mat-menu-before": e === "before", "mat-menu-after": e === "after", "mat-menu-above": t === "above", "mat-menu-below": t === "below" }), this._changeDetectorRef.markForCheck(); }
        _onAnimationDone(e) { let t = e === h; (t || e === D) && (t && (clearTimeout(this._exitFallbackTimeout), this._exitFallbackTimeout = void 0), this._animationDone.next(t ? "void" : "enter"), this._isAnimating.set(!1)); }
        _onAnimationStart(e) { (e === D || e === h) && this._isAnimating.set(!0); }
        _setIsOpen(e) { if (this._panelAnimationState = e ? "enter" : "void", e) {
            ...
            this._animationsDisabled || (this._exitFallbackTimeout = setTimeout(() => this._onAnimationDone(h), 200)); this._animationsDisabled && setTimeout(() => { this._onAnimationDone(e ? D : h); }), this._changeDetectorRef.markForCheck(); }
        _updateDirectDescendants() { this._allItems.changes.pipe(k(this._allItems)).subscribe(e => { this._directDescendantItems.reset(e.filter(t => t._parentMenu === this)), this._directDescendantItems.notifyOnChanges(); }); }
        ...
        static \u0275fac = function (t) { return new (t || a); };
        static \u0275cmp = n.\u0275\u0275defineComponent({ type: a, selectors: [["mat-menu"]], contentQueries: function (t, i, o) { if (t & 1 && (n.\u0275\u0275contentQuery(o, W, 5), n.\u0275\u0275contentQuery(o, R, 5), n.\u0275\u0275contentQuery(o, R, 4)), t & 2) {
                let r;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    _menuInternal;
    constructor(e) { this._canHaveBackdrop = e; let t = s(O, { optional: !0 }); this._parentMaterialMenu = t instanceof p ? t : void 0; }
    ...
    _createOverlay(e) { if (!this._overlayRef) {
        ...
        this._subscribeToPositions(e, t.positionStrategy), this._overlayRef = ye(this._injector, t), this._overlayRef.keydownEvents().subscribe(i => { this._menu instanceof p && this._menu._handleKeydown(i); });
    } return this._overlayRef; }
    _getOverlayConfig(e) { return new ve({ positionStrategy: Ce(this._injector, this._getOverlayOrigin()).withLockedPosition().withGrowAfterOpen().withTransformOriginOn(".mat-menu-panel, .mat-mdc-menu-panel"), backdropClass: e.backdropClass || "cdk-overlay-transparent-backdrop", panelClass: e.overlayPanelClass, scrollStrategy: this._scrollStrategy(), direction: this._dir || "ltr", disableAnimations: this._animationsDisabled }); }
    ...
    _setPosition(e, t) { let [i, o] = e.xPosition === "before" ? ["end", "start"] : ["start", "end"], [r, l] = e.yPosition === "above" ? ["bottom", "top"] : ["top", "bottom"], [M, y] = [r, l], [v, C] = [i, o], u = 0; if (this._triggersSubmenu()) {
        if (C = i = e.xPosition === "before" ? "start" : "end", o = v = i === "end" ? "start" : "end", this._parentMaterialMenu) {
            if (this._parentInnerPadding == null) {
                let E = this._parentMaterialMenu.items.first;
                this._parentInnerPadding = E ? E._getHostElement().offsetTop : 0;
            }
            u = r === "bottom" ? this._parentInnerPadding : -this._parentInnerPadding;
        }
    }
    else
        e.overlapTrigger || (M = r === "top" ? "bottom" : "top", y = l === "top" ? "bottom" : "top"); t.withPositions([{ originX: i, originY: M, overlayX: v, overlayY: r, offsetY: u }, { originX: o, originY: M, overlayX: C, overlayY: r, offsetY: u }, { originX: i, originY: y, overlayX: v, overlayY: l, offsetY: -u }, { originX: o, originY: y, overlayX: C, overlayY: l, offsetY: -u }]); }
    _menuClosingActions() { let e = this._getOutsideClickStream(this._overlayRef), t = this._overlayRef.detachments(), i = this._parentMaterialMenu ? this._parentMaterialMenu.closed : L(), o = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe(he(r => this._menuOpen && r !== this._menuItemInstance)) : L(); return P(e, i, o, t); }
    _getPortal(e) { return (!this._portal || this._portal.templateRef !== e.templateRef) && (this._portal = new Q(e.templateRef, this._viewContainerRef)), this._portal; }
    _ownsMenu(e) { return m.get(e) === this; }
    static \u0275fac = function (t) { n.\u0275\u0275invalidFactory(); };
    static \u0275dir = n.\u0275\u0275defineDirective({ type: a });
} return a; })(), dt = (() => { class a extends U {
    _cleanupTouchstart;
    _hoverSubscription = I.EMPTY;
    ...
    constructor() { super(!0); let e = s(ee); this._cleanupTouchstart = e.listen(this._element.nativeElement, "touchstart", t => { ne(t) || (this._openedBy = "touch"); }, { passive: !0 }); }
    ...
    _handleMousedown(e) { oe(e) || (this._openedBy = e.button === 0 ? "mouse" : void 0, this.triggersSubmenu() && e.preventDefault()); }
    _handleKeydown(e) { let t = e.keyCode; (t === me || t === ue) && (this._openedBy = "keyboard"), this.triggersSubmenu() && (t === j && this.dir === "ltr" || t === z && this.dir === "rtl") && (this._openedBy = "keyboard", this.openMenu()); }
    ...
    _getOutsideClickStream(e) { return e.outsidePointerEvents().pipe(pe((t, i) => t.type === "contextmenu" ? this._isWithinMenuOrTrigger(De(t)) : t.type === "auxclick" ? i === 0 ? !0 : (this._rootNode ??= Pe(this._element.nativeElement) || this._document, this._isWithinMenuOrTrigger(this._rootNode.elementFromPoint(t.clientX, t.clientY))) : this._triggerPressedControl && i === 0 && t.ctrlKey)); }
