import { a as Pt, b as Nt } from "@nf-internal/chunk-KW5C2IEB";
import { a as Y, b as K } from "@nf-internal/chunk-4CLCTAJ7";
import * as a from "@angular/core";
import { \u0275findLocaleData as y, \u0275LocaleDataIndex as f, \u0275getLocaleCurrencyCode as Gt, \u0275getLocalePluralCase as Ht, \u0275RuntimeError as b, \u0275formatRuntimeError as Wi, inject as Je, LOCALE_ID as x, createNgModule as Zt, NgModuleRef as Wt, RendererStyleFlags2 as Yt, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as Kt, \u0275isPromise as Xt, \u0275isSubscribable as qt, untracked as Ge, InjectionToken as Qe, DEFAULT_CURRENCY_CODE as Jt } from "@angular/core";
import * as T from "@angular/core";
import { inject as q, InjectionToken as $e, DOCUMENT as Ue, \u0275\u0275inject as kt } from "@angular/core";
...
var De = class {
    ...
    static \u0275prov = T.\u0275\u0275defineInjectable({ token: e, factory: () => q(je), providedIn: "platform" });
} return e; })(), Ut = new $e(""), je = (() => { class e extends U {
    _location;
    _history;
    _doc = q(Ue);
    ...
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = T.\u0275\u0275defineInjectable({ token: e, factory: () => new e, providedIn: "platform" });
} return e; })();
...
var P = (() => { class e {
    historyGo(t) { throw new Error(""); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = T.\u0275\u0275defineInjectable({ token: e, factory: () => q(Ve), providedIn: "root" });
} return e; })(), Q = new $e(""), Ve = (() => { class e extends P {
    _platformLocation;
    _baseHref;
    _removeListenerFns = [];
    ...
    static \u0275fac = function (n) { return new (n || e)(T.\u0275\u0275inject(U), T.\u0275\u0275inject(Q, 8)); };
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = Vt(ke(xe(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    normalize(t) { return e.stripTrailingSlash(jt(this._basePath, xe(t))); }
    ...
    static \u0275fac = function (n) { return new (n || e)(T.\u0275\u0275inject(P)); };
    static \u0275prov = T.\u0275\u0275defineInjectable({ token: e, factory: () => zt(), providedIn: "root" });
} return e; })();
function zt() { return new pe(kt(P)); }
function jt(e, i) { if (!e || !i.startsWith(e))
    return i; let t = i.substring(e.length); return t === "" || ["/", ";", "?", "#"].includes(t[0]) ? t : i; }
function xe(e) { return e.replace(/\/index.html$/, ""); }
function Vt(e) { if (new RegExp("^(https?:)?//").test(e)) {
    let [, t] = e.split(/\/\/[^\/]+/);
    return t;
} return e; }
var Qt = (() => { class e extends P {
    _platformLocation;
    _baseHref = "";
    _removeListenerFns = [];
...
function ut(e) { if (!e[f.ExtraData])
    throw new b(2303, !1); }
function ct(e) { let i = y(e); return ut(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? me(n) : [me(n[0]), me(n[1])]); }
function dt(e, i, t) { let n = y(e); ut(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], s = v(r, i) || []; return v(s, t) || []; }
...
var un = 2;
function ft(e) { let i, t = et[e]; return t && (i = t[2]), typeof i == "number" ? i : un; }
var cn = /^(\d{4,})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/, ee = {}, dn = /((?:[^BEGHLMOSWYZabcdhmswyz']+)|(?:'(?:[^']|'')*')|(?:G{1,5}|y{1,4}|Y{1,4}|M{1,5}|L{1,5}|w{1,2}|W{1}|d{1,2}|E{1,6}|c{1,6}|a{1,5}|b{1,5}|B{1,5}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|S{1,3}|z{1,4}|Z{1,5}|O{1,4}))([\s\S]*)/;
function ht(e, i, t, n) { let r = yn(e); i = R(t, i) || i; let o = [], u; for (; i;)
    if (u = dn.exec(i), u) {
...
function se(e, i, t) { let n = new Date(0); return n.setFullYear(e, i, t), n.setHours(0, 0, 0), n; }
function R(e, i) { let t = nt(e); if (ee[t] ??= {}, ee[t][i])
    ...
    case "fullTime":
        ...
        break;
    case "short":
        let r = R(e, "shortTime"), s = R(e, "shortDate");
        n = te(V(e, A.Short), [r, s]);
        break;
    case "medium":
        let o = R(e, "mediumTime"), u = R(e, "mediumDate");
        n = te(V(e, A.Medium), [o, u]);
        break;
    case "long":
        let D = R(e, "longTime"), h = R(e, "longDate");
        n = te(V(e, A.Long), [D, h]);
        break;
    case "full":
        let g = R(e, "fullTime"), c = R(e, "fullDate");
        n = te(V(e, A.Full), [g, c]);
        break;
} return n && (ee[t][i] = n), n; }
...
function ne(e) { return function (i, t, n) { let r = -1 * n, s = _(t, m.MinusSign), o = r > 0 ? Math.floor(r / 60) : Math.ceil(r / 60); switch (e) {
...
var gn = 0, re = 4;
function Dn(e) { let i = se(e, gn, 1).getDay(); return se(e, 0, 1 + (i <= re ? re : re + 7) - i); }
function gt(e) { let i = e.getDay(), t = i === 0 ? -3 : re - i; return se(e.getFullYear(), e.getMonth(), e.getDate() + t); }
function Ce(e, i = !1) { return function (t, n) { let r; if (i) {
    ...
    let s = gt(t), o = Dn(s.getFullYear()), u = s.getTime() - o.getTime();
    r = 1 + Math.round(u / 6048e5);
} return L(r, e, _(n, m.MinusSign)); }; }
function ie(e, i = !1) { return function (t, n) { let s = gt(t).getFullYear(); return L(s, e, _(n, m.MinusSign), i); }; }
var ye = {};
function pn(e) { if (ye[e])
...
var En = /^(\d+)?\.((\d+)(-(\d+))?)?$/, Ze = 22, oe = ".", G = "0", wn = ";", An = ",", Fe = "#", We = "\xA4", Sn = "%";
function _e(e, i, t, n, r, s, o = !1) { let u = "", D = !1; if (!isFinite(e))
    ...
    if (s) {
        ...
        if (k === null)
            throw new b(2306, !1);
        let Pe = k[1], ge = k[3], Ne = k[5];
        Pe != null && (g = Ee(Pe)), ge != null && (c = Ee(ge)), Ne != null ? F = Ee(Ne) : ge != null && c > F && (F = c);
    }
    vn(h, c, F);
    ...
    p.length && W.unshift(p.join("")), u = W.join(_(t, n)), B.length && (u += _(t, r) + B.join("")), $ && (u += _(t, m.Exponential) + "+" + $);
} return e < 0 && !D ? u = i.negPre + u + i.negSuf : u = i.posPre + u + i.posSuf, u; }
function pt(e, i, t, n, r) { let s = ce(i, Z.Currency), o = be(s, _(i, m.MinusSign)); return o.minFrac = ft(n), o.maxFrac = o.minFrac, _e(e, o, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(We, t).replace(We, "").trim(); }
function mt(e, i, t) { let n = ce(i, Z.Percent), r = be(n, _(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(Sn, "g"), _(i, m.PercentSign)); }
function Ct(e, i, t) { let n = ce(i, Z.Decimal), r = be(n, _(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t); }
function be(e, i = "-") { let t = { minInt: 1, minFrac: 0, maxFrac: 0, posPre: "", posSuf: "", negPre: "", negSuf: "", gSize: 0, lgSize: 0 }, n = e.split(wn), r = n[0], s = n[1], o = r.indexOf(oe) !== -1 ? r.split(oe) : [r.substring(0, r.lastIndexOf(G) + 1), r.substring(r.lastIndexOf(G) + 1)], u = o[0], D = o[1] || ""; t.posPre = u.substring(0, u.indexOf(Fe)); for (let g = 0; g < D.length; g++) {
    let c = D.charAt(g);
    c === G ? t.minFrac = t.maxFrac = g + 1 : c === Fe ? t.maxFrac = g + 1 : t.posSuf += c;
} let h = u.split(An); if (t.gSize = h[1] ? h[1].length : 0, t.lgSize = h[2] || h[1] ? (h[2] || h[1]).length : 0, s) {
    let g = r.length - t.posPre.length - t.posSuf.length, c = s.indexOf(Fe);
...
function bn(e) { let i = Math.abs(e) + "", t = 0, n, r, s, o, u; for ((r = i.indexOf(oe)) > -1 && (i = i.replace(oe, "")), (s = i.search(/e/i)) > 0 ? (r < 0 && (r = s), r += +i.slice(s + 1), i = i.substring(0, s)) : r < 0 && (r = i.length), s = 0; i.charAt(s) === G; s++)
    ; if (s === (u = i.length))
    n = [0], r = 1;
else {
    for (u--; i.charAt(u) === G;)
...
var de = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: () => new Ft(Je(x)), providedIn: "root" });
} return e; })();
...
var Ft = (() => { class e extends de {
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(we) : Ye; }
    ...
    ngOnChanges(t) { if (this._needToReCreateComponentInstance(t) && (this._viewContainerRef.clear(), this._inputsUsed.clear(), this._componentRef = void 0, this.ngComponentOutlet)) {
        ...
        this._needToReCreateNgModuleInstance(t) && (this._moduleRef?.destroy(), this.ngComponentOutletNgModule ? this._moduleRef = Zt(this.ngComponentOutletNgModule, Mn(n)) : this._moduleRef = void 0), this._componentRef = this._viewContainerRef.createComponent(this.ngComponentOutlet, { injector: n, ngModuleRef: this._moduleRef, projectableNodes: this.ngComponentOutletContent, environmentInjector: this.ngComponentOutletEnvironmentInjector });
    } }
...
function Mn(e) { return e.get(Wt).injector; }
var ae = class {
    $implicit;
    ngForOf;
    index;
    ...
    _applyChanges(t) { let n = this._viewContainer; t.forEachOperation((r, s, o) => { if (r.previousIndex == null)
        n.createEmbeddedView(this._template, new ae(r.item, this._ngForOf, -1, -1), o === null ? void 0 : o);
    else if (o == null)
...
var Ae = class {
...
} return e; })(), Gn = "mediumDate", At = new Qe(""), St = new Qe(""), Hn = (() => { class e {
    locale;
    defaultTimezone;
    defaultOptions;
    ...
    transform(t, n, r, s) { if (t == null || t === "" || t !== t)
        ...
        return ht(t, o, s || this.locale, u);
    }
    catch (o) {
        throw M(e, o.message);
    } }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(At, 24), a.\u0275\u0275directiveInject(St, 24)); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "date", type: e, pure: !0 });
} return e; })(), Zn = /#/g, Wn = (() => { class e {
    _localization;
    constructor(t) { this._localization = t; }
    transform(t, n, r) { if (t == null)
        return ""; if (typeof n != "object" || n === null)
        throw M(e, n); let s = yt(t, Object.keys(n), this._localization, r); return n[s].replace(Zn, t.toString()); }
...
var Jn = (() => { class e {
    ...
    transform(t, n = this._defaultCurrencyCode, r = "symbol", s, o) { if (!Ie(t))
        return null; o ||= this._locale, typeof r == "boolean" && (r = r ? "symbol" : "code"); let u = n || this._defaultCurrencyCode; r !== "code" && (r === "symbol" || r === "symbol-narrow" ? u = lt(u, r === "symbol" ? "wide" : "narrow", o) : u = r); try {
        let D = Le(t);
        return pt(D, o, u, n, s);
    }
    catch (D) {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(Jt, 16)); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "currency", type: e, pure: !0 });
} return e; })();
function Ie(e) { return !(e == null || e === "" || e !== e); }
function Le(e) { if (typeof e == "string" && !isNaN(Number(e) - parseFloat(e)))
...
import { inject as I, DestroyRef as Mt, \u0275registerLocaleData as ii, Version as ri, \u0275\u0275defineInjectable as si, DOCUMENT as Tt, \u0275formatRuntimeError as oi, InjectionToken as Re, \u0275RuntimeError as Oe, \u0275IMAGE_CONFIG as ai, Renderer2 as ui, ElementRef as ci, Injector as di, \u0275performanceMarkFeature as li, numberAttribute as vt, booleanAttribute as le, \u0275IMAGE_CONFIG_DEFAULTS as fi, \u0275unwrapSafeValue as hi, ChangeDetectorRef as gi } from "@angular/core";
import { DOCUMENT as Rr, \u0275IMAGE_CONFIG as Or } from "@angular/core";
...
function mr(e, i, t) { return ii(e, i, t); }
var Di = "browser", pi = "server";
function Cr(e) { return e === Di; }
function yr(e) { return e === pi; }
var Fr = new ri("21.0.2"), Er = (() => { class e {
    static \u0275prov = si({ token: e, providedIn: "root", factory: () => typeof ngServerMode < "u" && ngServerMode ? new Te : new Me(I(Tt), window) });
} return e; })(), Me = class {
    document;
    window;
    offset = () => [0, 0];
    ...
    scrollToAnchor(i, t) { let n = mi(this.document, i); n && (this.scrollToElement(n, t), n.focus()); }
...
function mi(e, i) { let t = e.getElementById(i) || e.getElementsByName(i)[0]; if (t)
...
function Rt(e) { return /^https?:\/\//.test(e); }
...
function Ci(e) { return e.endsWith("/") ? e.slice(0, -1) : e; }
function yi(e) { return e.startsWith("/") ? e.slice(1) : e; }
var Bt = e => e.src, Be = new Re("", { factory: () => Bt });
function he(e, i) { return function (n) { return Ot(n) || Fi(n, i || []), n = Ci(n), [{ provide: Be, useValue: o => (Rt(o.src) && Ei(n, o.src), e(n, K(Y({}, o), { src: yi(o.src) }))) }]; }; }
function Fi(e, i) { throw new Oe(2959, !1); }
function Ei(e, i) { throw new Oe(2959, !1); }
var wr = he(wi, void 0);
function wi(e, i) { let t = "format=auto"; return i.width && (t += `,width=${i.width}`), i.isPlaceholder && (t += `,quality=${fe}`), `${e}/cdn-cgi/image/${t}/${i.src}`; }
var Ar = he(Ai, void 0);
function Ai(e, i) { let n = `f_auto,${i.isPlaceholder ? "q_auto:low" : "q_auto"}`; return i.width && (n += `,w_${i.width}`), i.loaderParams?.rounded && (n += ",r_max"), `${e}/image/upload/${n}/${i.src}`; }
var Sr = he(Si, void 0);
function Si(e, i) { let { src: t, width: n } = i, r = []; n && r.push(`w-${n}`), i.isPlaceholder && r.push(`q-${fe}`); let s = r.length ? [e, `tr:${r.join(",")}`, t] : [e, t]; return new URL(s.join("/")).href; }
var _r = he(_i, void 0);
function _i(e, i) { let t = new URL(`${e}/${i.src}`); return t.searchParams.set("auto", "format"), i.width && t.searchParams.set("w", i.width.toString()), i.isPlaceholder && t.searchParams.set("q", fe), t.href; }
function br(e) { if (e && !Ot(e))
    throw new Oe(2959, !1); return e && (e = new URL(e).origin), [{ provide: Be, useValue: n => bi(n, e) }]; }
var It = new Map([["height", "h"], ["fit", "fit"], ["quality", "q"], ["q", "q"], ["position", "position"]]);
function bi(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !Rt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", fe); for (let [r, s] of Object.entries(e.loaderParams ?? {}))
    It.has(r) && t.searchParams.set(It.get(r), s.toString()); return t.hostname === "a" ? t.href.replace(t.origin, "") : t.href; }
var vr = new Re("");
var vi = new Re("", { factory: () => new Set }), Ii = (() => { class e {
    preloadedImages = I(vi);
    document = I(Tt);
    errorShown = !1;
...
var Ir = (() => { class e {
    ...
    getRewrittenSrcset() { let t = Lt.test(this.ngSrcset); return this.ngSrcset.split(",").filter(r => r !== "").map(r => { r = r.trim(); let s = t ? parseFloat(r) : parseFloat(r) * this.width; return `${this.callImageLoader({ src: this.ngSrc, width: s })} ${r}`; }).join(", "); }
    getAutomaticSrcset() { return this.sizes ? this.getResponsiveSrcset() : this.getFixedSrcset(); }
    getResponsiveSrcset() { let { breakpoints: t } = this.config, n = t; return this.sizes?.trim() === "100vw" && (n = t.filter(s => s >= Mi)), n.map(s => `${this.callImageLoader({ src: this.ngSrc, width: s })} ${s}w`).join(", "); }
    ...
    getFixedSrcset() { return Li.map(n => `${this.callImageLoader({ src: this.ngSrc, width: this.width * n })} ${n}x`).join(", "); }
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > Ti || this.height > Ri), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Bt && !t; }
    ...
    removePlaceholderOnLoad(t) { let n = () => { let o = this.injector.get(gi); r(), s(), this.placeholder = !1, o.markForCheck(); }, r = this.renderer.listen(t, "load", n), s = this.renderer.listen(t, "error", n); this.destroyRef.onDestroy(() => { r(), s(); }), Bi(t, n); }
    setHostAttribute(t, n) { this.renderer.setAttribute(this.imgElement, t, n); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275dir = O.\u0275\u0275defineDirective({ type: e, selectors: [["img", "ngSrc", ""]], hostVars: 18, hostBindings: function (n, r) { n & 2 && O.\u0275\u0275styleProp("position", r.fill ? "absolute" : null)("width", r.fill ? "100%" : null)("height", r.fill ? "100%" : null)("inset", r.fill ? "0" : null)("background-size", r.placeholder ? "cover" : null)("background-position", r.placeholder ? "50% 50%" : null)("background-repeat", r.placeholder ? "no-repeat" : null)("background-image", r.placeholder ? r.generatePlaceholder(r.placeholder) : null)("filter", r.placeholder && r.shouldBlurPlaceholder(r.placeholderConfig) ? "blur(15px)" : null); }, inputs: { ngSrc: [2, "ngSrc", "ngSrc", Pi], ngSrcset: "ngSrcset", sizes: "sizes", width: [2, "width", "width", vt], height: [2, "height", "height", vt], decoding: "decoding", loading: "loading", priority: [2, "priority", "priority", le], loaderParams: "loaderParams", disableOptimizedSrcset: [2, "disableOptimizedSrcset", "disableOptimizedSrcset", le], fill: [2, "fill", "fill", le], placeholder: [2, "placeholder", "placeholder", Ni], placeholderConfig: "placeholderConfig", src: "src", srcset: "srcset" }, features: [O.\u0275\u0275NgOnChangesFeature] });
} return e; })();
function Oi(e) { let i = {}; return e.breakpoints && (i.breakpoints = e.breakpoints.sort((t, n) => t - n)), Object.assign({}, fi, e, i); }
...
export { Q as APP_BASE_HREF, $n as AsyncPipe, je as BrowserPlatformLocation, ni as CommonModule, ei as CurrencyPipe, St as DATE_PIPE_DEFAULT_OPTIONS, At as DATE_PIPE_DEFAULT_TIMEZONE, Rr as DOCUMENT, Hn as DatePipe, Jn as DecimalPipe, E as FormStyle, A as FormatWidth, Qt as HashLocationStrategy, Wn as I18nPluralPipe, Yn as I18nSelectPipe, Or as IMAGE_CONFIG, Be as IMAGE_LOADER, Kn as JsonPipe, qn as KeyValuePipe, Ut as LOCATION_INITIALIZED, pe as Location, P as LocationStrategy, Un as LowerCasePipe, In as NgClass, Ln as NgComponentOutlet, Et as NgFor, Et as NgForOf, ae as NgForOfContext, Tn as NgIf, ue as NgIfContext, Ft as NgLocaleLocalization, de as NgLocalization, Ir as NgOptimizedImage, wt as NgPlural, Bn as NgPluralCase, Pn as NgStyle, ve as NgSwitch, Rn as NgSwitchCase, On as NgSwitchDefault, Nn as NgTemplateOutlet, Z as NumberFormatStyle, m as NumberSymbol, vr as PRECONNECT_CHECK_BLOCKLIST, Ve as PathLocationStrategy, Qn as PercentPipe, U as PlatformLocation, bt as PlatformNavigation, N as Plural, ti as SlicePipe, jn as TitleCasePipe, d as TranslationWidth, Vn as UpperCasePipe, Fr as VERSION, Er as ViewportScroller, tt as WeekDay, Nt as XhrFactory, pt as formatCurrency, ht as formatDate, Ct as formatNumber, mt as formatPercent, lt as getCurrencySymbol, sn as getLocaleCurrencyCode, rn as getLocaleCurrencyName, nn as getLocaleCurrencySymbol, z as getLocaleDateFormat, V as getLocaleDateTimeFormat, rt as getLocaleDayNames, it as getLocaleDayPeriods, an as getLocaleDirection, ot as getLocaleEraNames, ct as getLocaleExtraDayPeriodRules, dt as getLocaleExtraDayPeriods, en as getLocaleFirstDayOfWeek, nt as getLocaleId, st as getLocaleMonthNames, ce as getLocaleNumberFormat, _ as getLocaleNumberSymbol, at as getLocalePluralCase, j as getLocaleTimeFormat, tn as getLocaleWeekEndRange, ft as getNumberOfCurrencyDigits, Cr as isPlatformBrowser, yr as isPlatformServer, wr as provideCloudflareLoader, Ar as provideCloudinaryLoader, Sr as provideImageKitLoader, _r as provideImgixLoader, br as provideNetlifyLoader, mr as registerLocaleData, De as \u0275DomAdapter, pr as \u0275NavigationAdapterForLocation, Te as \u0275NullViewportScroller, Di as \u0275PLATFORM_BROWSER_ID, pi as \u0275PLATFORM_SERVER_ID, X as \u0275getDOM, S as \u0275normalizeQueryParams, Pt as \u0275parseCookieValue, $t as \u0275setRootDomAdapter };
